...
| Negative precision (forbidden hits) | Whether the *wrong* memory stayed out | [open-cowork](../systems/open-cowork/), [Verel](../systems/verel/) and [MIRIX](../systems/mirix/) — three of seventy-six, and MIRIX's cases are about scope rather than correction |
