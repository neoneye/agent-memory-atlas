...
| Negative precision (forbidden hits) | Whether the *wrong* memory stayed out | [open-cowork](../systems/open-cowork/), [Verel](../systems/verel/), [MIRIX](../systems/mirix/) and [Aukora Kernel](../systems/aukora-kernel/) — four of seventy-nine, and the last two are about scope rather than correction |
