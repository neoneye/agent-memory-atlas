...
polecat in the rig without anyone copying a file. It also means nothing ranks,
...
wrong. That keyspace is read in the [Gas Town](../systems/gastown/) report, at
beads `v1.0.5`, because Gas Town's `gt remember` writes into it with types and
both CLIs inject it. beads' issues stay out of scope; its memory is covered
there.
