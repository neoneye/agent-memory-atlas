...
twenty-one systems of 327, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and two repositories
of three hundred and twenty-seven, and they are not all
...
negative retrieval assertion count — one hundred and two systems of three
hundred and twenty-seven — is live, checked against report frontmatter on every build. Thirty-seven
