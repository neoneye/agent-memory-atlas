...
thirty-five systems of 421, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and seventy repositories of four hundred and twenty-one, and they are not all
...
negative retrieval assertion count — one hundred and seventy systems of four hundred and twenty-one — is live, checked against report frontmatter on every build. Thirty-seven
