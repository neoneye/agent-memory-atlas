...
thirty-five systems of 422, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and seventy-one repositories of four hundred and twenty-two, and they are not all
...
negative retrieval assertion count — one hundred and seventy-one systems of four hundred and twenty-two — is live, checked against report frontmatter on every build. Thirty-seven
