...
thirty-nine systems of 436, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and eighty-three repositories of four hundred and thirty-six, and they are not all
...
negative retrieval assertion count — one hundred and eighty-three systems of four hundred and thirty-six — is live, checked against report frontmatter on every build. Thirty-seven
...
- **Two axes the seven marks do not carry, named by a survey that coded 435
  ...
  **Recoverability** asks whether a decision taken on a bad record can be traced
  ...
  So rarity is not what keeps recoverability off the list: the 27 of 436 that
