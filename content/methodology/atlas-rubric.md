...
forty-two systems of 452 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and ninety-five repositories of four hundred and fifty-two, and they are not all
...
negative retrieval assertion count — one hundred and ninety-five systems of four hundred and fifty-two — is live, checked against report frontmatter on every build. Thirty-seven
