...
twenty-one systems of 352, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and twenty-one repositories
of three hundred and fifty-two, and they are not all
...
negative retrieval assertion count — one hundred and twenty-one systems of three
hundred and fifty-two — is live, checked against report frontmatter on every build. Thirty-seven
