...
forty-two systems of 447 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and ninety-one repositories of four hundred and forty-seven, and they are not all
...
negative retrieval assertion count — one hundred and ninety-one systems of four hundred and forty-seven — is live, checked against report frontmatter on every build. Thirty-seven
