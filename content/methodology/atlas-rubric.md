...
forty-four systems of 462 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by two hundred and thirty-one repositories of four hundred and sixty-two, and they are not all
...
negative retrieval assertion count — two hundred and thirty-one systems of four hundred and sixty-two — is live, checked against report frontmatter on every build. Thirty-seven
