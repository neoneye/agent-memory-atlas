...
twenty-one systems of 341, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and fourteen repositories
of three hundred and forty-one, and they are not all
...
negative retrieval assertion count — one hundred and fourteen systems of three
hundred and forty-one — is live, checked against report frontmatter on every build. Thirty-seven
