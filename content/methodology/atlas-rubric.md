...
twenty-one systems of 324, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and one repositories
of three hundred and twenty-four, and they are not all
...
negative retrieval assertion count — one hundred and one systems of three
hundred and twenty-four — is live, checked against report frontmatter on every build. Thirty-seven
