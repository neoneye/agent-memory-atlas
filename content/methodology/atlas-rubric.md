...
forty-one systems of 443 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and eighty-nine repositories of four hundred and forty-three, and they are not all
...
negative retrieval assertion count — one hundred and eighty-nine systems of four hundred and forty-three — is live, checked against report frontmatter on every build. Thirty-seven
