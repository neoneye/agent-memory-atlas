...
twenty-one systems of 328, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and three repositories
of three hundred and twenty-eight, and they are not all
...
negative retrieval assertion count — one hundred and three systems of three
hundred and twenty-eight — is live, checked against report frontmatter on every build. Thirty-seven
