...
twenty-seven systems of 362, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and twenty-eight repositories
of three hundred and sixty-two, and they are not all
...
negative retrieval assertion count — one hundred and twenty-eight systems of three
hundred and sixty-two — is live, checked against report frontmatter on every build. Thirty-seven
