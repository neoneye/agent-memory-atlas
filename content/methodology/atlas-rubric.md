...
forty-two systems of 451 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and ninety-four repositories of four hundred and fifty-one, and they are not all
...
negative retrieval assertion count — one hundred and ninety-four systems of four hundred and fifty-one — is live, checked against report frontmatter on every build. Thirty-seven
