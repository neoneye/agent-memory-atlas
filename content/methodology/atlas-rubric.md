...
twenty-one systems of 302, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by eighty-three repositories
of three hundred and two, and they are not all
...
negative retrieval assertion count — eighty-three systems of three
hundred and two — is live, checked against report frontmatter on every build. Thirty-seven
