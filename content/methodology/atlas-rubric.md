...
twenty-one systems of 323, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred repositories
of three hundred and twenty-three, and they are not all
...
negative retrieval assertion count — one hundred systems of three
hundred and twenty-three — is live, checked against report frontmatter on every build. Thirty-seven
