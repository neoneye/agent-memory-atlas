...
forty-four systems of 460 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by two hundred and twenty-nine repositories of four hundred and sixty, and they are not all
...
negative retrieval assertion count — two hundred and twenty-nine systems of four hundred and sixty — is live, checked against report frontmatter on every build. Thirty-seven
