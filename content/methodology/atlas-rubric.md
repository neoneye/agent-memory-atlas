...
forty-one systems of 446 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and ninety repositories of four hundred and forty-six, and they are not all
...
negative retrieval assertion count — one hundred and ninety systems of four hundred and forty-six — is live, checked against report frontmatter on every build. Thirty-seven
