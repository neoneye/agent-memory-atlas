...
forty-four systems of 461 carry a value-level tombstone, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by two hundred and thirty repositories of four hundred and sixty-one, and they are not all
...
negative retrieval assertion count — two hundred and thirty systems of four hundred and sixty-one — is live, checked against report frontmatter on every build. Thirty-seven
