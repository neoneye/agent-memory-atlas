...
twenty-one systems of 351, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and twenty repositories
of three hundred and fifty-one, and they are not all
...
negative retrieval assertion count — one hundred and twenty systems of three
hundred and fifty-one — is live, checked against report frontmatter on every build. Thirty-seven
