...
thirty-five systems of 423, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and seventy-two repositories of four hundred and twenty-three, and they are not all
...
negative retrieval assertion count — one hundred and seventy-two systems of four hundred and twenty-three — is live, checked against report frontmatter on every build. Thirty-seven
