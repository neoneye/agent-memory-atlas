...
thirty-three systems of 402, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and fifty-three repositories of four hundred and two, and they are not all
...
negative retrieval assertion count — one hundred and fifty-three systems of four hundred and two — is live, checked against report frontmatter on every build. Thirty-seven
