...
twenty-one systems of 317, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by ninety-three repositories
of three hundred and seventeen, and they are not all
...
negative retrieval assertion count — ninety-three systems of three
hundred and seventeen — is live, checked against report frontmatter on every build. Thirty-seven
