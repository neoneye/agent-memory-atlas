...
twenty-one systems of 343, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and sixteen repositories
of three hundred and forty-three, and they are not all
...
negative retrieval assertion count — one hundred and sixteen systems of three
hundred and forty-three — is live, checked against report frontmatter on every build. Thirty-seven
