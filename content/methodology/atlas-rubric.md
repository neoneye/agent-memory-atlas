...
twenty-one systems of 329, and the corpus is an opportunistic collection rather
...
retrieval assertion is carried by one hundred and four repositories
of three hundred and twenty-nine, and they are not all
...
negative retrieval assertion count — one hundred and four systems of three
hundred and twenty-nine — is live, checked against report frontmatter on every build. Thirty-seven
