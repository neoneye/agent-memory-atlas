...
description: A code-grounded comparison of one hundred and forty-two agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
1. **Correction is the phase that goes unbuilt.** 4 systems of 142 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   77 of 142 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 17 of 142 commit a case
...
5. **Trust is usually a number, not a state.** 19 of 142 record a discrete
...
**Why the two counts differ.** The atlas holds **142 reports across 141
...
so a count of *systems* is 142 and a count of *repositories* is 141 — the gap is
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 77 of 142 systems here have, and is what the mark means. A scope
...
One hundred and forty-two systems do not fall into one hundred and forty-two categories. They cluster around
...
`project-golem`, `openyak`, `memento`, `palazzo`, `memex-zero-rag`, `agentrecall-x`, `terse-memory`, `ean-agentos`, `memsem`
...
[capability index](../capabilities/) filters all 142 systems by the seven
...
*4 of 142:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*26 of 142:* [`aukora-kernel`](../systems/aukora-kernel/), [`aura`](../systems/aura/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`echo-agent`](../systems/echo-agent/), [`hippo-memory`](../systems/hippo-memory/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memledger`](../systems/memledger/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memsem`](../systems/memsem/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`nova-ai`](../systems/nova-ai/), [`optmem`](../systems/optmem/), [`palazzo`](../systems/palazzo/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Eighteen repositories of one hundred and forty-two
...
disputed or forbidden stays gone. Eleven of one hundred and forty-two is the real figure for the
...
polluting a research agent's recall. Across one hundred and forty-two systems, almost none can
