...
description: A code-grounded comparison of one hundred and sixty-five agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
165 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 9 systems of 165 carry a
...
**Why the two counts differ.** The atlas holds **165 reports across 164
...
165 carry a licence that is not open source**, each named in its own report and
now collected here:
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 95 of 165 systems here have, and is what the mark means. A scope
...
One hundred and sixty-five systems do not fall into one hundred and sixty-four categories. They cluster around
...
[capability index](../capabilities/) filters all 165 systems by the seven
...
*9 of 165:* [`daimon`](../systems/daimon/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`nova-ai`](../systems/nova-ai/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Thirty-seven repositories of one hundred and sixty-five
...
disputed or forbidden stays gone. Eleven of one hundred and sixty-five is the real figure for the
...
polluting a research agent's recall. Across one hundred and sixty-five systems, almost none can
