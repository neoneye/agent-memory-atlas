...
description: A code-grounded comparison of one hundred and eighty-eight agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
188 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 10 systems of 188 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   110 of 188 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 42 of 188 commit a case
...
5. **Trust is usually a number, not a state.** 36 of 188 record a discrete
...
**Why the two counts differ.** The atlas holds **188 reports across 187
...
Two consequences worth stating plainly. The atlas's headline counts — ten
tombstones, forty-two negative-eval suites — are counts *over inspectable code*, and a
...
1. **Whether correction is possible at all.** Almost everything can overwrite
   or supersede. Ten systems in this entire atlas can record that a *value*
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 110 of 188 systems here have, and is what the mark means. A scope
...
One hundred and eighty-eight systems do not fall into one hundred and sixty-six categories. They cluster around
...
[capability index](../capabilities/) filters all 188 systems by the seven
...
*10 of 188:* [`daimon`](../systems/daimon/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`nova-ai`](../systems/nova-ai/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`wenlan`](../systems/wenlan/)
...
*110 of 188:* [`acontext`](../systems/acontext/), [`adk-python`](../systems/adk-python/), [`aeris`](../systems/aeris/), [`agent-framework`](../systems/agent-framework/), [`agent-memory-supabase`](../systems/agent-memory-supabase/), [`agentmemory`](../systems/agentmemory/), [`agentrecall-x`](../systems/agentrecall-x/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`ai-memory`](../systems/ai-memory/), [`aimaos`](../systems/aimaos/), [`alma-memory`](../systems/alma-memory/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`basic-memory`](../systems/basic-memory/), [`brain-md`](../systems/brain-md/), [`buzz`](../systems/buzz/), [`claude-mem`](../systems/claude-mem/), [`clawmem`](../systems/clawmem/), [`cognee`](../systems/cognee/), [`cognicore`](../systems/cognicore/), [`cognis`](../systems/cognis/), [`core-memory`](../systems/core-memory/), [`core-redplanet`](../systems/core-redplanet/), [`cortex`](../systems/cortex/), [`cowagent`](../systems/cowagent/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`deer-flow`](../systems/deer-flow/), [`ean-agentos`](../systems/ean-agentos/), [`ecc`](../systems/ecc/), [`echo-agent`](../systems/echo-agent/), [`elastic-atlas`](../systems/elastic-atlas/), [`empirica`](../systems/empirica/), [`empryo`](../systems/empryo/), [`engram`](../systems/engram/), [`everos`](../systems/everos/), [`gbrain`](../systems/gbrain/), [`gini-agent`](../systems/gini-agent/), [`gobii`](../systems/gobii/), [`graphiti`](../systems/graphiti/), [`hindsight`](../systems/hindsight/), [`hippo-memory`](../systems/hippo-memory/), [`honcho`](../systems/honcho/), [`intaris`](../systems/intaris/), [`langmem`](../systems/langmem/), [`letta`](../systems/letta/), [`livingfeed`](../systems/livingfeed/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mastra-observational-memory`](../systems/mastra-observational-memory/), [`mateclaw`](../systems/mateclaw/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memanto`](../systems/memanto/), [`membase`](../systems/membase/), [`memento`](../systems/memento/), [`memmachine`](../systems/memmachine/), [`memobase`](../systems/memobase/), [`memori`](../systems/memori/), [`memory-engine`](../systems/memory-engine/), [`memory-lancedb-pro`](../systems/memory-lancedb-pro/), [`memoryops-ai`](../systems/memoryops-ai/), [`memos`](../systems/memos/), [`mempalace`](../systems/mempalace/), [`memsem`](../systems/memsem/), [`metaclaw`](../systems/metaclaw/), [`midas`](../systems/midas/), [`mimir`](../systems/mimir/), [`mirix`](../systems/mirix/), [`mnemory`](../systems/mnemory/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neko`](../systems/neko/), [`neo4j-agent-memory`](../systems/neo4j-agent-memory/), [`nooa-memory`](../systems/nooa-memory/), [`nornicdb`](../systems/nornicdb/), [`octopoda-os`](../systems/octopoda-os/), [`omega-memory`](../systems/omega-memory/), [`omi`](../systems/omi/), [`openclaw`](../systems/openclaw/), [`openhuman`](../systems/openhuman/), [`opensre`](../systems/opensre/), [`openviking`](../systems/openviking/), [`openworker`](../systems/openworker/), [`openyak`](../systems/openyak/), [`ostk-recall`](../systems/ostk-recall/), [`perseus-vault`](../systems/perseus-vault/), [`powermem`](../systems/powermem/), [`prime-agent`](../systems/prime-agent/), [`promptx`](../systems/promptx/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`redis-agent-memory-server`](../systems/redis-agent-memory-server/), [`simplemem`](../systems/simplemem/), [`superlocalmemory`](../systems/superlocalmemory/), [`supermemory`](../systems/supermemory/), [`tigrimosr`](../systems/tigrimosr/), [`token-savior`](../systems/token-savior/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`wenlan`](../systems/wenlan/), [`yantrikdb`](../systems/yantrikdb/), [`yesmem`](../systems/yesmem/)
...
*55 of 188:* [`agentmemory`](../systems/agentmemory/), [`alma-memory`](../systems/alma-memory/), [`aukora-kernel`](../systems/aukora-kernel/), [`aura`](../systems/aura/), [`brain-md`](../systems/brain-md/), [`clawmem`](../systems/clawmem/), [`core-memory`](../systems/core-memory/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`echo-agent`](../systems/echo-agent/), [`empirica`](../systems/empirica/), [`engram-alpha`](../systems/engram-alpha/), [`hindsight`](../systems/hindsight/), [`hippo-memory`](../systems/hippo-memory/), [`icarus`](../systems/icarus/), [`kirocrew`](../systems/kirocrew/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memledger`](../systems/memledger/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`memvid`](../systems/memvid/), [`midas`](../systems/midas/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neko`](../systems/neko/), [`nornicdb`](../systems/nornicdb/), [`nova-ai`](../systems/nova-ai/), [`octopoda-os`](../systems/octopoda-os/), [`omega-memory`](../systems/omega-memory/), [`omi`](../systems/omi/), [`optmem`](../systems/optmem/), [`ostk-recall`](../systems/ostk-recall/), [`palazzo`](../systems/palazzo/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`shodh-memory`](../systems/shodh-memory/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`superlocalmemory`](../systems/superlocalmemory/), [`token-savior`](../systems/token-savior/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`vestige`](../systems/vestige/), [`vibe-cognition`](../systems/vibe-cognition/), [`yantrikdb`](../systems/yantrikdb/)
...
*47 of 188:* [`acontext`](../systems/acontext/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`cambium`](../systems/cambium/), [`clio`](../systems/clio/), [`core-memory`](../systems/core-memory/), [`cortex`](../systems/cortex/), [`daimon`](../systems/daimon/), [`deer-flow`](../systems/deer-flow/), [`dexto`](../systems/dexto/), [`empryo`](../systems/empryo/), [`engram`](../systems/engram/), [`engram-alpha`](../systems/engram-alpha/), [`hermes-agent`](../systems/hermes-agent/), [`iai-pme`](../systems/iai-pme/), [`intaris`](../systems/intaris/), [`juggler`](../systems/juggler/), [`kage`](../systems/kage/), [`kirocrew`](../systems/kirocrew/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`memanto`](../systems/memanto/), [`memora`](../systems/memora/), [`memory-palace`](../systems/memory-palace/), [`memory-project`](../systems/memory-project/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mercury-agent`](../systems/mercury-agent/), [`mnemory`](../systems/mnemory/), [`nova-ai`](../systems/nova-ai/), [`npcpy`](../systems/npcpy/), [`omi`](../systems/omi/), [`opensre`](../systems/opensre/), [`openyak`](../systems/openyak/), [`ostk-recall`](../systems/ostk-recall/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`risuai`](../systems/risuai/), [`second-me`](../systems/second-me/), [`tigrimosr`](../systems/tigrimosr/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`vestige`](../systems/vestige/), [`waku-agent`](../systems/waku-agent/), [`wenlan`](../systems/wenlan/)

**Negative retrieval assertion** — Committed evaluation cases asserting that particular material must *not* be retrieved.

*42 of 188:* [`aeris`](../systems/aeris/), [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`brain-md`](../systems/brain-md/), [`cognis`](../systems/cognis/), [`core-memory`](../systems/core-memory/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`engram-alpha`](../systems/engram-alpha/), [`everos`](../systems/everos/), [`gbrain`](../systems/gbrain/), [`graphify`](../systems/graphify/), [`helix-agi`](../systems/helix-agi/), [`helm`](../systems/helm/), [`iai-pme`](../systems/iai-pme/), [`icarus`](../systems/icarus/), [`kage`](../systems/kage/), [`kirocrew`](../systems/kirocrew/), [`lethe`](../systems/lethe/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`midas`](../systems/midas/), [`mimir`](../systems/mimir/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neko`](../systems/neko/), [`nooa-memory`](../systems/nooa-memory/), [`omi`](../systems/omi/), [`open-cowork`](../systems/open-cowork/), [`opensre`](../systems/opensre/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
a scope key when retrieving, while ten systems carry a value-level tombstone.
...
**Negative evidence is almost never tested.** Forty-two repositories of one hundred and eighty-eight
...
disputed or forbidden stays gone. Eleven of one hundred and eighty-eight is the real figure for the
...
has published it. Meanwhile ten repositories here implement a value-level
...
polluting a research agent's recall. Across one hundred and eighty-eight systems, almost none can
