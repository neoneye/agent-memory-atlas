...
description: A code-grounded comparison of two hundred and forty-six agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
246 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 12 systems of 246 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   138 of 246 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 53 of 246 commit a case
...
5. **Trust is usually a number, not a state.** 46 of 246 record a discrete
...
**Why the two counts differ.** The atlas holds **246 reports across 245
...
tombstones, fifty-three negative-eval suites — are counts *over inspectable code*, and a
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 138 of 246 systems here have, and is what the mark means. A scope
...
Two hundred and forty-six systems do not fall into one hundred and sixty-six categories. They cluster around
...
[capability index](../capabilities/) filters all 246 systems by the seven
...
**Negative evidence is almost never tested.** Fifty-three repositories of two hundred and forty-six
...
disputed or forbidden stays gone. Twelve of two hundred and forty-six is the real figure for the
...
polluting a research agent's recall. Across two hundred and forty-six systems, almost none can
