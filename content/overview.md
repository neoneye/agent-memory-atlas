...
description: A code-grounded comparison of one hundred and fifty-two agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
152 open-source memory systems, each read at a pinned commit and judged against
seven mechanisms with strict definitions. Corpus last extended **6 August 2026**.
Five findings, with the counts they rest on:

1. **Correction is the phase that goes unbuilt.** 9 systems of 152 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   86 of 152 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 28 of 152 commit a case
...
5. **Trust is usually a number, not a state.** 27 of 152 record a discrete
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 86 of 152 systems here have, and is what the mark means. A scope
...
One hundred and fifty-two systems do not fall into one hundred and fifty-two categories. They cluster around
...
*9 of 152:* [`daimon`](../systems/daimon/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`nova-ai`](../systems/nova-ai/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*36 of 152:* [`acontext`](../systems/acontext/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`cambium`](../systems/cambium/), [`clio`](../systems/clio/), [`core-memory`](../systems/core-memory/), [`cortex`](../systems/cortex/), [`daimon`](../systems/daimon/), [`deer-flow`](../systems/deer-flow/), [`dexto`](../systems/dexto/), [`empryo`](../systems/empryo/), [`engram`](../systems/engram/), [`hermes-agent`](../systems/hermes-agent/), [`juggler`](../systems/juggler/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`memanto`](../systems/memanto/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mercury-agent`](../systems/mercury-agent/), [`nova-ai`](../systems/nova-ai/), [`npcpy`](../systems/npcpy/), [`omi`](../systems/omi/), [`openyak`](../systems/openyak/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`risuai`](../systems/risuai/), [`second-me`](../systems/second-me/), [`tigrimosr`](../systems/tigrimosr/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`waku-agent`](../systems/waku-agent/)

**Negative retrieval assertion** — Committed evaluation cases asserting that particular material must *not* be retrieved.

*28 of 152:* [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`core-memory`](../systems/core-memory/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`everos`](../systems/everos/), [`graphify`](../systems/graphify/), [`helm`](../systems/helm/), [`lethe`](../systems/lethe/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`mnemosyne`](../systems/mnemosyne/), [`neko`](../systems/neko/), [`nooa-memory`](../systems/nooa-memory/), [`omi`](../systems/omi/), [`open-cowork`](../systems/open-cowork/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Twenty-eight repositories of one hundred and fifty-two
...
disputed or forbidden stays gone. Eleven of one hundred and fifty-two is the real figure for the
