...
description: A code-grounded comparison of one hundred and nineteen agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 65 of 119 systems here have, and is what the mark means. A scope
...
One hundred and nineteen systems do not fall into one hundred and nineteen categories. They cluster around
...
*3 of 119:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`verel`](../systems/verel/)
...
*11 of 119:* [`clio`](../systems/clio/), [`core-memory`](../systems/core-memory/), [`daimon`](../systems/daimon/), [`gini-agent`](../systems/gini-agent/), [`graphify`](../systems/graphify/), [`magic-context`](../systems/magic-context/), [`npcpy`](../systems/npcpy/), [`rainbox`](../systems/rainbox/), [`tigrimosr`](../systems/tigrimosr/), [`tokenmizer`](../systems/tokenmizer/), [`verel`](../systems/verel/)

**Bi-temporal validity** — When a fact was true tracked separately from when the system recorded or expired it.

*9 of 119:* [`agent-memory-supabase`](../systems/agent-memory-supabase/), [`atomic-agent`](../systems/atomic-agent/), [`core-memory`](../systems/core-memory/), [`gini-agent`](../systems/gini-agent/), [`graphiti`](../systems/graphiti/), [`memory-engine`](../systems/memory-engine/), [`memvid`](../systems/memvid/), [`neo4j-agent-memory`](../systems/neo4j-agent-memory/), [`verel`](../systems/verel/)
...
*17 of 119:* [`aukora-kernel`](../systems/aukora-kernel/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memora`](../systems/memora/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`optmem`](../systems/optmem/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`tokenmizer`](../systems/tokenmizer/), [`verel`](../systems/verel/)
...
*24 of 119:* [`acontext`](../systems/acontext/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`clio`](../systems/clio/), [`core-memory`](../systems/core-memory/), [`cortex`](../systems/cortex/), [`daimon`](../systems/daimon/), [`dexto`](../systems/dexto/), [`engram`](../systems/engram/), [`hermes-agent`](../systems/hermes-agent/), [`juggler`](../systems/juggler/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`memanto`](../systems/memanto/), [`memora`](../systems/memora/), [`mercury-agent`](../systems/mercury-agent/), [`npcpy`](../systems/npcpy/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`risuai`](../systems/risuai/), [`second-me`](../systems/second-me/), [`soulforge`](../systems/soulforge/), [`tigrimosr`](../systems/tigrimosr/), [`verel`](../systems/verel/)

**Negative retrieval assertion** — Committed evaluation cases asserting that particular material must *not* be retrieved.

*16 of 119:* [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`aukora-kernel`](../systems/aukora-kernel/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`everos`](../systems/everos/), [`graphify`](../systems/graphify/), [`helm`](../systems/helm/), [`lethe`](../systems/lethe/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`neko`](../systems/neko/), [`open-cowork`](../systems/open-cowork/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Sixteen repositories of one hundred and nineteen
...
disputed or forbidden stays gone. Eleven of one hundred and nineteen is the real figure for the
...
polluting a research agent's recall. Across one hundred and nineteen systems, almost none can
...
- Nine repositories examined in the same round have no reports. `razzant/ouroboros` is cited in the append-only-memory-audit pattern for its "honest journal" fix rather than given a report. `openyak/openyak` carries **no licence file at all**, so all rights reserved by default, and could not be reviewed on that basis. (`truffle-ai/dexto` and `Arvincreator/project-golem` were excluded here on the same ground and have since been reviewed — see [Dexto](../systems/dexto/) and [Project Golem](../systems/project-golem/).) `OtterMind/youclaw` is small. `SixHq/Overture`'s only memory artifacts are `.claude/agent-memory/*/MEMORY.md` — Claude Code's own memory used while developing the repo, not a system it ships. `husu/loom` is an AI JSON Schema documentation generator, `AaronWong1999/hermesclaw` a launcher for running Hermes Agent, OpenClaw, and OpenCode on one WeChat account, and `KeyID-AI/agent-kit` gives MCP clients an email address; none is agent memory.
