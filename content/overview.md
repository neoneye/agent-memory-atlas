...
description: A code-grounded comparison of one hundred and thirty-one agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
**Why the two counts differ.** The atlas holds **131 reports across 130
...
[Holographic](../systems/holographic/). Counts of *systems* are 131 and counts of
*repositories* are 130; neither is a rounding error.
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 71 of 131 systems here have, and is what the mark means. A scope
...
One hundred and thirty-one systems do not fall into one hundred and thirty-one categories. They cluster around
...
`project-golem`, `openyak`, `memento`, `palazzo`, `memex-zero-rag`, `agentrecall-x`, `terse-memory`
...
*4 of 131:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*21 of 131:* [`aukora-kernel`](../systems/aukora-kernel/), [`aura`](../systems/aura/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memledger`](../systems/memledger/), [`memora`](../systems/memora/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`optmem`](../systems/optmem/), [`palazzo`](../systems/palazzo/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Sixteen repositories of one hundred and thirty-one
...
disputed or forbidden stays gone. Eleven of one hundred and thirty-one is the real figure for the
...
polluting a research agent's recall. Across one hundred and thirty-one systems, almost none can
