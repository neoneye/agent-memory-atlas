...
description: A code-grounded comparison of one hundred and sixty-two agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
162 open-source memory systems, each read at a pinned commit and judged against
seven mechanisms with strict definitions. Corpus last extended **6 August 2026**.
Five findings, with the counts they rest on:

1. **Correction is the phase that goes unbuilt.** 9 systems of 162 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   93 of 162 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 35 of 162 commit a case
...
5. **Trust is usually a number, not a state.** 29 of 162 record a discrete
...
**Why the two counts differ.** The atlas holds **162 reports across 161
...
so a count of *systems* is 162 and a count of *repositories* is 161 — the gap is
...
tombstones, thirty-five negative-eval suites — are counts *over inspectable code*, and a
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 93 of 162 systems here have, and is what the mark means. A scope
...
One hundred and sixty-two systems do not fall into one hundred and sixty-two categories. They cluster around
...
[capability index](../capabilities/) filters all 162 systems by the seven
...
*9 of 162:* [`daimon`](../systems/daimon/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`nova-ai`](../systems/nova-ai/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*35 of 162:* [`aeris`](../systems/aeris/), [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`brain-md`](../systems/brain-md/), [`cognis`](../systems/cognis/), [`core-memory`](../systems/core-memory/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`engram-alpha`](../systems/engram-alpha/), [`everos`](../systems/everos/), [`graphify`](../systems/graphify/), [`helix-agi`](../systems/helix-agi/), [`helm`](../systems/helm/), [`kirocrew`](../systems/kirocrew/), [`lethe`](../systems/lethe/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mimir`](../systems/mimir/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`mnemosyne`](../systems/mnemosyne/), [`neko`](../systems/neko/), [`nooa-memory`](../systems/nooa-memory/), [`omi`](../systems/omi/), [`open-cowork`](../systems/open-cowork/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Thirty-five repositories of one hundred and sixty-two
...
disputed or forbidden stays gone. Eleven of one hundred and sixty-two is the real figure for the
...
polluting a research agent's recall. Across one hundred and sixty-two systems, almost none can
