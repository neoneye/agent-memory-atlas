...
description: A code-grounded comparison of one hundred and one agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 59 of 101 systems here have, and is what the mark means. A scope
...
One hundred and one systems do not fall into one hundred and one categories. They cluster around
...
*3 of 101:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`verel`](../systems/verel/)
...
*11 of 101:* [`aukora-kernel`](../systems/aukora-kernel/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`magic-context`](../systems/magic-context/), [`memora`](../systems/memora/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`optmem`](../systems/optmem/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Ten repositories of one hundred and one
...
disputed or forbidden stays gone. Six of one hundred and one is the real figure for the
...
polluting a research agent's recall. Across one hundred and one systems, almost none can
