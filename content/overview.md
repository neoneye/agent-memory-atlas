...
description: A code-grounded comparison of one hundred and thirty-eight agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
1. **Correction is the phase that goes unbuilt.** 4 systems of 138 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   74 of 138 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 17 of 138 commit a case
...
5. **Trust is usually a number, not a state.** 18 of 138 record a discrete
...
**Why the two counts differ.** The atlas holds **138 reports across 135
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 74 of 138 systems here have, and is what the mark means. A scope
...
One hundred and thirty-eight systems do not fall into one hundred and thirty-eight categories. They cluster around
...
[capability index](../capabilities/) filters all 138 systems by the seven
...
*4 of 138:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*24 of 138:* [`aukora-kernel`](../systems/aukora-kernel/), [`aura`](../systems/aura/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`echo-agent`](../systems/echo-agent/), [`hippo-memory`](../systems/hippo-memory/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memledger`](../systems/memledger/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`optmem`](../systems/optmem/), [`palazzo`](../systems/palazzo/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Seventeen repositories of one hundred and thirty-eight
...
disputed or forbidden stays gone. Eleven of one hundred and thirty-eight is the real figure for the
...
polluting a research agent's recall. Across one hundred and thirty-eight systems, almost none can
