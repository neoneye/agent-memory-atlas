...
description: A code-grounded comparison of one hundred and thirty-seven agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
1. **Correction is the phase that goes unbuilt.** 4 systems of 137 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   74 of 137 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 17 of 137 commit a case
...
5. **Trust is usually a number, not a state.** 18 of 137 record a discrete
...
**Why the two counts differ.** The atlas holds **137 reports across 135
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 74 of 137 systems here have, and is what the mark means. A scope
...
One hundred and thirty-seven systems do not fall into one hundred and thirty-seven categories. They cluster around
...
[capability index](../capabilities/) filters all 137 systems by the seven
...
*4 of 137:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*24 of 137:* [`aukora-kernel`](../systems/aukora-kernel/), [`aura`](../systems/aura/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`echo-agent`](../systems/echo-agent/), [`hippo-memory`](../systems/hippo-memory/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memledger`](../systems/memledger/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`optmem`](../systems/optmem/), [`palazzo`](../systems/palazzo/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Seventeen repositories of one hundred and thirty-seven
...
disputed or forbidden stays gone. Eleven of one hundred and thirty-seven is the real figure for the
...
polluting a research agent's recall. Across one hundred and thirty-seven systems, almost none can
