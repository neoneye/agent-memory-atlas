...
before it decides what they *do*.
...
- [Cyb3rb1ade/openclaw-plur1bus-memory](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory) at [`241aac282e20c40819bdfffef0f9ce7115abd936`](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory/commit/241aac282e20c40819bdfffef0f9ce7115abd936) — read only; both manifests were inside the cooldown and the package's `postinstall` patches the host OpenClaw's dist directory, so nothing was installed and nothing was run. The unreferenced `plur1bus/` directory, a v5 copy of the plugin, was not treated as part of the system
