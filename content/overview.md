...
238 memory systems with publicly readable source, each read at a pinned commit
...
3. **Scope is the most implemented mechanism and the shallowest.**
   133 of 238 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 50 of 238 commit a case
...
5. **Trust is usually a number, not a state.** 46 of 238 record a discrete
...
**Why the two counts differ.** The atlas holds **238 reports across 237
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 133 of 238 systems here have, and is what the mark means. A scope
...
Two hundred and thirty-eight systems do not fall into one hundred and sixty-six categories. They cluster around
...
**Negative evidence is almost never tested.** Fifty repositories of two hundred and thirty-eight
...
polluting a research agent's recall. Across two hundred and thirty-eight systems, almost none can
...
- [The-825/breadcrumbs](https://github.com/The-825/breadcrumbs) at [`9252553434e01cfb4058df797470c72645eef3fc`](https://github.com/The-825/breadcrumbs/commit/9252553434e01cfb4058df797470c72645eef3fc) — the fleet architecture its docs describe is not in the tree
