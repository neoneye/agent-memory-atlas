...
description: A code-grounded comparison of two hundred and eighty-five agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
285 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 16 systems of 285 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   156 of 285 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 72 of 285 commit a case
...
5. **Trust is usually a number, not a state.** 58 of 285 record a discrete
...
**Why the two counts differ.** The atlas holds **285 reports across 284
...
so a count of *systems* is 285 and a count of *repositories* is 284 — the gap is
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 156 of 285 systems here have, and is what the mark means. A scope
...
Two hundred and eighty-five systems do not fall into one hundred and seventy categories. They cluster around
...
[capability index](../capabilities/) filters all 285 systems by the seven
...
*32 of 285:* [`agent-memory-doctrine`](../systems/agent-memory-doctrine/), [`agent-memory-supabase`](../systems/agent-memory-supabase/), [`atomic-agent`](../systems/atomic-agent/), [`claude-total-memory`](../systems/claude-total-memory/), [`clawmem`](../systems/clawmem/), [`core-memory`](../systems/core-memory/), [`core-redplanet`](../systems/core-redplanet/), [`daem0n-mcp`](../systems/daem0n-mcp/), [`engram-alpha`](../systems/engram-alpha/), [`engram-provable`](../systems/engram-provable/), [`gini-agent`](../systems/gini-agent/), [`graphiti`](../systems/graphiti/), [`hippo-memory`](../systems/hippo-memory/), [`memory-engine`](../systems/memory-engine/), [`memory-lancedb-pro`](../systems/memory-lancedb-pro/), [`memsem`](../systems/memsem/), [`memv`](../systems/memv/), [`memvid`](../systems/memvid/), [`midas`](../systems/midas/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neo4j-agent-memory`](../systems/neo4j-agent-memory/), [`neurakeep`](../systems/neurakeep/), [`omega-memory`](../systems/omega-memory/), [`omi`](../systems/omi/), [`ostk-recall`](../systems/ostk-recall/), [`perseus-vault`](../systems/perseus-vault/), [`plur1bus`](../systems/plur1bus/), [`provem`](../systems/provem/), [`verel`](../systems/verel/), [`vestige`](../systems/vestige/), [`zep`](../systems/zep/)
...
**Negative evidence is almost never tested.** Seventy-two repositories of two hundred and eighty-five
...
disputed or forbidden stays gone. Twelve of two hundred and eighty-five is the real figure for the
...
polluting a research agent's recall. Across two hundred and eighty-five systems, almost none can
