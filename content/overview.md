...
199 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 11 systems of 199 carry a
...
**Why the two counts differ.** The atlas holds **199 reports across 198
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 116 of 199 systems here have, and is what the mark means. A scope
...
One hundred and ninety-nine systems do not fall into one hundred and sixty-six categories. They cluster around
...
[capability index](../capabilities/) filters all 199 systems by the seven
...
**Negative evidence is almost never tested.** Forty-two repositories of one hundred and ninety-nine
...
polluting a research agent's recall. Across one hundred and ninety-nine systems, almost none can
