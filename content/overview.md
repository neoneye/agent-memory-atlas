...
3. **Scope is the most implemented mechanism and the shallowest.**
   ...
   then ignores.
4. **Negative evidence is almost never tested.** 26 of 151 commit a case
...
5. **Trust is usually a number, not a state.** 25 of 151 record a discrete
...
**Negative evidence is almost never tested.** Twenty-six repositories of one hundred and fifty-one
