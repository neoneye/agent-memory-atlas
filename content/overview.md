...
description: A code-grounded comparison of one hundred and eighty-two agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
182 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 10 systems of 182 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   105 of 182 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 41 of 182 commit a case
...
5. **Trust is usually a number, not a state.** 35 of 182 record a discrete
...
**Why the two counts differ.** The atlas holds **182 reports across 181
...
tombstones, forty-one negative-eval suites — are counts *over inspectable code*, and a
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 105 of 182 systems here have, and is what the mark means. A scope
...
One hundred and eighty-two systems do not fall into one hundred and sixty-six categories. They cluster around
...
[capability index](../capabilities/) filters all 182 systems by the seven
...
*10 of 182:* [`daimon`](../systems/daimon/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`nova-ai`](../systems/nova-ai/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`wenlan`](../systems/wenlan/)
...
*50 of 182:* [`agentmemory`](../systems/agentmemory/), [`alma-memory`](../systems/alma-memory/), [`aukora-kernel`](../systems/aukora-kernel/), [`aura`](../systems/aura/), [`brain-md`](../systems/brain-md/), [`clawmem`](../systems/clawmem/), [`core-memory`](../systems/core-memory/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`echo-agent`](../systems/echo-agent/), [`engram-alpha`](../systems/engram-alpha/), [`hindsight`](../systems/hindsight/), [`hippo-memory`](../systems/hippo-memory/), [`icarus`](../systems/icarus/), [`kirocrew`](../systems/kirocrew/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memledger`](../systems/memledger/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`memvid`](../systems/memvid/), [`midas`](../systems/midas/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neko`](../systems/neko/), [`nova-ai`](../systems/nova-ai/), [`octopoda-os`](../systems/octopoda-os/), [`omega-memory`](../systems/omega-memory/), [`omi`](../systems/omi/), [`optmem`](../systems/optmem/), [`ostk-recall`](../systems/ostk-recall/), [`palazzo`](../systems/palazzo/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`shodh-memory`](../systems/shodh-memory/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`token-savior`](../systems/token-savior/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`vestige`](../systems/vestige/)
...
**Negative evidence is almost never tested.** Forty-one repositories of one hundred and eighty-two
...
disputed or forbidden stays gone. Eleven of one hundred and eighty-two is the real figure for the
...
polluting a research agent's recall. Across one hundred and eighty-two systems, almost none can
