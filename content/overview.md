...
1. **Correction is the phase that goes unbuilt.** 16 systems of 284 carry a
...
Two consequences worth stating plainly. The atlas's headline counts — sixteen
...
1. **Whether correction is possible at all.** Almost everything can overwrite
   or supersede. Sixteen, in this entire atlas, can record that a *value*
...
*16 of 284:* [`breadcrumbs`](../systems/breadcrumbs/), [`daimon`](../systems/daimon/), [`memory-compiler`](../systems/memory-compiler/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`noosphere`](../systems/noosphere/), [`nova-ai`](../systems/nova-ai/), [`open-second-brain`](../systems/open-second-brain/), [`perseus-vault`](../systems/perseus-vault/), [`plur1bus`](../systems/plur1bus/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`sonder-runtime`](../systems/sonder-runtime/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`wenlan`](../systems/wenlan/)
...
*32 of 284:* [`agent-memory-doctrine`](../systems/agent-memory-doctrine/), [`agent-memory-supabase`](../systems/agent-memory-supabase/), [`atomic-agent`](../systems/atomic-agent/), [`claude-total-memory`](../systems/claude-total-memory/), [`clawmem`](../systems/clawmem/), [`core-memory`](../systems/core-memory/), [`core-redplanet`](../systems/core-redplanet/), [`daem0n-mcp`](../systems/daem0n-mcp/), [`engram-alpha`](../systems/engram-alpha/), [`engram-provable`](../systems/engram-provable/), [`gini-agent`](../systems/gini-agent/), [`graphiti`](../systems/graphiti/), [`hippo-memory`](../systems/hippo-memory/), [`memory-engine`](../systems/memory-engine/), [`memory-lancedb-pro`](../systems/memory-lancedb-pro/), [`memsem`](../systems/memsem/), [`memv`](../systems/memv/), [`memvid`](../systems/memvid/), [`midas`](../systems/midas/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neo4j-agent-memory`](../systems/neo4j-agent-memory/), [`neurakeep`](../systems/neurakeep/), [`omega-memory`](../systems/omega-memory/), [`omi`](../systems/omi/), [`ostk-recall`](../systems/ostk-recall/), [`perseus-vault`](../systems/perseus-vault/), [`plur1bus`](../systems/plur1bus/), [`provem`](../systems/provem/), [`verel`](../systems/verel/), [`vestige`](../systems/vestige/), [`zep`](../systems/zep/)
...
- [Cyb3rb1ade/openclaw-plur1bus-memory](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory) at [`b550a2d84f607da28438b39d86f1edd04e0951ff`](https://github.com/Cyb3rb1ade/openclaw-plur1bus-memory/commit/b550a2d84f607da28438b39d86f1edd04e0951ff) — release 7.3.0; both manifests inside the cooldown and the package's `postinstall` patches the host OpenClaw's dist directory, so nothing was installed or run this reading. The v7.3.0 validity window, content-fingerprint tombstone, hard-filtering epistemic `invalidated` status and the REM-dream/`/critical` scope fixes were read from `lib/valid-time.js`, `lib/tombstone.js`, `lib/epistemic-status.js`, `lib/dreaming/rem-dream.js` and `lib/critical-review.js` against the committed tests
