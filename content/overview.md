...
1. **Correction is the phase that goes unbuilt.** 19 systems of 289 carry a
...
Two consequences worth stating plainly. The atlas's headline counts — nineteen
...
*19 of 289:* [`agent-memory-doctrine`](../systems/agent-memory-doctrine/), [`breadcrumbs`](../systems/breadcrumbs/), [`daimon`](../systems/daimon/), [`hippo-memory`](../systems/hippo-memory/), [`memmy-agent`](../systems/memmy-agent/), [`memory-compiler`](../systems/memory-compiler/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`noosphere`](../systems/noosphere/), [`nova-ai`](../systems/nova-ai/), [`open-second-brain`](../systems/open-second-brain/), [`perseus-vault`](../systems/perseus-vault/), [`plur1bus`](../systems/plur1bus/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`sonder-runtime`](../systems/sonder-runtime/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`wenlan`](../systems/wenlan/)
...
- [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) at [`35815a04026c685594e7d80ecb94f73662508186`](https://github.com/kitfunso/hippo-memory/commit/35815a04026c685594e7d80ecb94f73662508186)
...
- [MythologIQ-Labs-LLC/agent-memory](https://github.com/MythologIQ-Labs-LLC/agent-memory) at [`0df4cf3337b3752105e1b5a110f38eee31f46fef`](https://github.com/MythologIQ-Labs-LLC/agent-memory/commit/0df4cf3337b3752105e1b5a110f38eee31f46fef) — read only; the tree carries no dependency manifest, so nothing was installed. The shipped `scripts/` validators were run as-is, and the residue partition was exercised through a driver written for this review over copies of two stdlib-only modules
