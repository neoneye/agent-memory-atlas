...
description: A code-grounded comparison of one hundred and sixty-four agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
3. **Scope is the most implemented mechanism and the shallowest.**
   94 of 164 apply a scope key as a filter on the read path. It is also
...
so a count of *systems* is 164 and a count of *repositories* is 163 — the gap is
...
tombstones, thirty-seven negative-eval suites — are counts *over inspectable code*, and a
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 94 of 164 systems here have, and is what the mark means. A scope
...
One hundred and sixty-four systems do not fall into one hundred and sixty-four categories. They cluster around
...
[capability index](../capabilities/) filters all 164 systems by the seven
...
*9 of 164:* [`daimon`](../systems/daimon/), [`memsem`](../systems/memsem/), [`mnemosyne`](../systems/mnemosyne/), [`nova-ai`](../systems/nova-ai/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*30 of 164:* [`aeris`](../systems/aeris/), [`agentic-context-engine`](../systems/agentic-context-engine/), [`agentrecall-x`](../systems/agentrecall-x/), [`alma-memory`](../systems/alma-memory/), [`aura`](../systems/aura/), [`cambium`](../systems/cambium/), [`clio`](../systems/clio/), [`cognicore`](../systems/cognicore/), [`core-memory`](../systems/core-memory/), [`daimon`](../systems/daimon/), [`engram-alpha`](../systems/engram-alpha/), [`gini-agent`](../systems/gini-agent/), [`graphify`](../systems/graphify/), [`hippo-memory`](../systems/hippo-memory/), [`magic-context`](../systems/magic-context/), [`memledger`](../systems/memledger/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`muninndb`](../systems/muninndb/), [`nova-ai`](../systems/nova-ai/), [`npcpy`](../systems/npcpy/), [`omi`](../systems/omi/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`rainbox`](../systems/rainbox/), [`terse-memory`](../systems/terse-memory/), [`tigrimosr`](../systems/tigrimosr/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)

**Bi-temporal validity** — When a fact was true tracked separately from when the system recorded or expired it.

*17 of 164:* [`agent-memory-supabase`](../systems/agent-memory-supabase/), [`atomic-agent`](../systems/atomic-agent/), [`core-memory`](../systems/core-memory/), [`engram-alpha`](../systems/engram-alpha/), [`gini-agent`](../systems/gini-agent/), [`graphiti`](../systems/graphiti/), [`hippo-memory`](../systems/hippo-memory/), [`memory-engine`](../systems/memory-engine/), [`memsem`](../systems/memsem/), [`memvid`](../systems/memvid/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neo4j-agent-memory`](../systems/neo4j-agent-memory/), [`omi`](../systems/omi/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`verel`](../systems/verel/)
...
*94 of 164:* [`acontext`](../systems/acontext/), [`adk-python`](../systems/adk-python/), [`aeris`](../systems/aeris/), [`agent-framework`](../systems/agent-framework/), [`agent-memory-supabase`](../systems/agent-memory-supabase/), [`agentmemory`](../systems/agentmemory/), [`agentrecall-x`](../systems/agentrecall-x/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`ai-memory`](../systems/ai-memory/), [`aimaos`](../systems/aimaos/), [`alma-memory`](../systems/alma-memory/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`basic-memory`](../systems/basic-memory/), [`brain-md`](../systems/brain-md/), [`buzz`](../systems/buzz/), [`claude-mem`](../systems/claude-mem/), [`cognee`](../systems/cognee/), [`cognicore`](../systems/cognicore/), [`cognis`](../systems/cognis/), [`core-memory`](../systems/core-memory/), [`cortex`](../systems/cortex/), [`cowagent`](../systems/cowagent/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`deer-flow`](../systems/deer-flow/), [`ean-agentos`](../systems/ean-agentos/), [`ecc`](../systems/ecc/), [`echo-agent`](../systems/echo-agent/), [`elastic-atlas`](../systems/elastic-atlas/), [`empryo`](../systems/empryo/), [`engram`](../systems/engram/), [`everos`](../systems/everos/), [`gini-agent`](../systems/gini-agent/), [`gobii`](../systems/gobii/), [`graphiti`](../systems/graphiti/), [`hindsight`](../systems/hindsight/), [`hippo-memory`](../systems/hippo-memory/), [`honcho`](../systems/honcho/), [`intaris`](../systems/intaris/), [`langmem`](../systems/langmem/), [`letta`](../systems/letta/), [`livingfeed`](../systems/livingfeed/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mastra-observational-memory`](../systems/mastra-observational-memory/), [`mateclaw`](../systems/mateclaw/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memanto`](../systems/memanto/), [`membase`](../systems/membase/), [`memento`](../systems/memento/), [`memmachine`](../systems/memmachine/), [`memobase`](../systems/memobase/), [`memori`](../systems/memori/), [`memory-engine`](../systems/memory-engine/), [`memoryops-ai`](../systems/memoryops-ai/), [`memos`](../systems/memos/), [`mempalace`](../systems/mempalace/), [`memsem`](../systems/memsem/), [`metaclaw`](../systems/metaclaw/), [`mimir`](../systems/mimir/), [`mirix`](../systems/mirix/), [`mnemory`](../systems/mnemory/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neko`](../systems/neko/), [`neo4j-agent-memory`](../systems/neo4j-agent-memory/), [`nooa-memory`](../systems/nooa-memory/), [`omi`](../systems/omi/), [`openclaw`](../systems/openclaw/), [`openhuman`](../systems/openhuman/), [`openviking`](../systems/openviking/), [`openworker`](../systems/openworker/), [`openyak`](../systems/openyak/), [`perseus-vault`](../systems/perseus-vault/), [`powermem`](../systems/powermem/), [`prime-agent`](../systems/prime-agent/), [`promptx`](../systems/promptx/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`redis-agent-memory-server`](../systems/redis-agent-memory-server/), [`simplemem`](../systems/simplemem/), [`supermemory`](../systems/supermemory/), [`tigrimosr`](../systems/tigrimosr/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*41 of 164:* [`acontext`](../systems/acontext/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`cambium`](../systems/cambium/), [`clio`](../systems/clio/), [`core-memory`](../systems/core-memory/), [`cortex`](../systems/cortex/), [`daimon`](../systems/daimon/), [`deer-flow`](../systems/deer-flow/), [`dexto`](../systems/dexto/), [`empryo`](../systems/empryo/), [`engram`](../systems/engram/), [`engram-alpha`](../systems/engram-alpha/), [`hermes-agent`](../systems/hermes-agent/), [`iai-pme`](../systems/iai-pme/), [`intaris`](../systems/intaris/), [`juggler`](../systems/juggler/), [`kirocrew`](../systems/kirocrew/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`memanto`](../systems/memanto/), [`memora`](../systems/memora/), [`memory-project`](../systems/memory-project/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mercury-agent`](../systems/mercury-agent/), [`mnemory`](../systems/mnemory/), [`nova-ai`](../systems/nova-ai/), [`npcpy`](../systems/npcpy/), [`omi`](../systems/omi/), [`openyak`](../systems/openyak/), [`perseus-vault`](../systems/perseus-vault/), [`provem`](../systems/provem/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`risuai`](../systems/risuai/), [`second-me`](../systems/second-me/), [`tigrimosr`](../systems/tigrimosr/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/), [`waku-agent`](../systems/waku-agent/)

**Negative retrieval assertion** — Committed evaluation cases asserting that particular material must *not* be retrieved.

*37 of 164:* [`aeris`](../systems/aeris/), [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`brain-md`](../systems/brain-md/), [`cognis`](../systems/cognis/), [`core-memory`](../systems/core-memory/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`engram-alpha`](../systems/engram-alpha/), [`everos`](../systems/everos/), [`graphify`](../systems/graphify/), [`helix-agi`](../systems/helix-agi/), [`helm`](../systems/helm/), [`iai-pme`](../systems/iai-pme/), [`kirocrew`](../systems/kirocrew/), [`lethe`](../systems/lethe/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mimir`](../systems/mimir/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`mnemosyne`](../systems/mnemosyne/), [`muninndb`](../systems/muninndb/), [`neko`](../systems/neko/), [`nooa-memory`](../systems/nooa-memory/), [`omi`](../systems/omi/), [`open-cowork`](../systems/open-cowork/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
disputed or forbidden stays gone. Eleven of one hundred and sixty-four is the real figure for the
...
polluting a research agent's recall. Across one hundred and sixty-four systems, almost none can
...
- [Perseus-Computing-LLC/perseus-vault](https://github.com/Perseus-Computing-LLC/perseus-vault) at [`4008228ee4fb1846bef562d91037b4be11356de4`](https://github.com/Perseus-Computing-LLC/perseus-vault/commit/4008228ee4fb1846bef562d91037b4be11356de4)
