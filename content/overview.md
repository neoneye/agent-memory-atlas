...
description: A code-grounded comparison of two hundred and seventy-six agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
276 memory systems with publicly readable source, each read at a pinned commit
...
1. **Correction is the phase that goes unbuilt.** 14 systems of 276 carry a
...
3. **Scope is the most implemented mechanism and the shallowest.**
   149 of 276 apply a scope key as a filter on the read path. It is also
   the mark most often satisfied by a single predicate that a background job
   then ignores.
4. **Negative evidence is almost never tested.** 68 of 276 commit a case
...
5. **Trust is usually a number, not a state.** 55 of 276 record a discrete
...
**Why the two counts differ.** The atlas holds **276 reports across 275
...
so a count of *systems* is 276 and a count of *repositories* is 275 — the gap is
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 149 of 276 systems here have, and is what the mark means. A scope
...
Two hundred and seventy-six systems do not fall into one hundred and seventy categories. They cluster around
...
[capability index](../capabilities/) filters all 276 systems by the seven
...
**Negative evidence is almost never tested.** Sixty-eight repositories of two hundred and seventy-six
...
disputed or forbidden stays gone. Twelve of two hundred and seventy-six is the real figure for the
...
polluting a research agent's recall. Across two hundred and seventy-six systems, almost none can
