...
3. **Scope is the most implemented mechanism and the shallowest.**
   ...
   then ignores.
4. **Negative evidence is almost never tested.** 27 of 152 commit a case
...
*27 of 152:* [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`argo`](../systems/argo/), [`aukora-kernel`](../systems/aukora-kernel/), [`core-memory`](../systems/core-memory/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`deepcode`](../systems/deepcode/), [`everos`](../systems/everos/), [`graphify`](../systems/graphify/), [`helm`](../systems/helm/), [`lethe`](../systems/lethe/), [`memoryops-ai`](../systems/memoryops-ai/), [`memsem`](../systems/memsem/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`mnemosyne`](../systems/mnemosyne/), [`neko`](../systems/neko/), [`omi`](../systems/omi/), [`open-cowork`](../systems/open-cowork/), [`perseus-vault`](../systems/perseus-vault/), [`prime-agent`](../systems/prime-agent/), [`provem`](../systems/provem/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Twenty-seven repositories of one hundred and fifty-two
