...
description: A code-grounded comparison of one hundred and twenty-three agent memory architectures, their retrieval mechanics, trust models, and operational tradeoffs.
root: ..
...
3. **Whether scope is identity or decoration.** Three levels, and the atlas's
   ...
   path* is what 69 of 123 systems here have, and is what the mark means. A scope
...
One hundred and twenty-three systems do not fall into one hundred and twenty-three categories. They cluster around
...
`logseq`, `everos`, `ecc`, `skales`, `csm`, `graphify`, `clio`, `soulforge`,
`project-golem`, `openyak`, `memento`
...
*4 of 123:* [`daimon`](../systems/daimon/), [`rainbox`](../systems/rainbox/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*18 of 123:* [`aukora-kernel`](../systems/aukora-kernel/), [`csm`](../systems/csm/), [`ctx`](../systems/ctx/), [`daimon`](../systems/daimon/), [`lethe`](../systems/lethe/), [`lorekit`](../systems/lorekit/), [`magic-context`](../systems/magic-context/), [`mem0`](../systems/mem0/), [`mem0sharp`](../systems/mem0sharp/), [`memora`](../systems/memora/), [`memvid`](../systems/memvid/), [`neko`](../systems/neko/), [`optmem`](../systems/optmem/), [`simplemem`](../systems/simplemem/), [`soul-of-waifu`](../systems/soul-of-waifu/), [`tokenmizer`](../systems/tokenmizer/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
*26 of 123:* [`acontext`](../systems/acontext/), [`agentswarms`](../systems/agentswarms/), [`agno`](../systems/agno/), [`clio`](../systems/clio/), [`core-memory`](../systems/core-memory/), [`cortex`](../systems/cortex/), [`daimon`](../systems/daimon/), [`dexto`](../systems/dexto/), [`engram`](../systems/engram/), [`hermes-agent`](../systems/hermes-agent/), [`juggler`](../systems/juggler/), [`llm-wiki-memory`](../systems/llm-wiki-memory/), [`lorekit`](../systems/lorekit/), [`memanto`](../systems/memanto/), [`memora`](../systems/memora/), [`mercury-agent`](../systems/mercury-agent/), [`npcpy`](../systems/npcpy/), [`openyak`](../systems/openyak/), [`qwen-code`](../systems/qwen-code/), [`rainbox`](../systems/rainbox/), [`risuai`](../systems/risuai/), [`second-me`](../systems/second-me/), [`soulforge`](../systems/soulforge/), [`tigrimosr`](../systems/tigrimosr/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)

**Negative retrieval assertion** — Committed evaluation cases asserting that particular material must *not* be retrieved.

*17 of 123:* [`agent-afk`](../systems/agent-afk/), [`agno`](../systems/agno/), [`aukora-kernel`](../systems/aukora-kernel/), [`crewai`](../systems/crewai/), [`csm`](../systems/csm/), [`daimon`](../systems/daimon/), [`everos`](../systems/everos/), [`graphify`](../systems/graphify/), [`helm`](../systems/helm/), [`lethe`](../systems/lethe/), [`mirix`](../systems/mirix/), [`mnemopi`](../systems/mnemopi/), [`neko`](../systems/neko/), [`open-cowork`](../systems/open-cowork/), [`pydantic-ai-harness`](../systems/pydantic-ai-harness/), [`universal-memory-engine`](../systems/universal-memory-engine/), [`verel`](../systems/verel/)
...
**Negative evidence is almost never tested.** Sixteen repositories of one hundred and twenty-three
...
disputed or forbidden stays gone. Eleven of one hundred and twenty-three is the real figure for the
...
polluting a research agent's recall. Across one hundred and twenty-three systems, almost none can
...
- Biggest risk: the corroboration counter behind that tier reads two environment variables the repository never assigns, so both sources collapse to `unknown:unknown`, the sybil dedup rejects the second, and nothing can ever promote.
...
- [SyntheticAutonomicMind/CLIO](https://github.com/SyntheticAutonomicMind/CLIO) at [`1c84ed9cb6161304579123ce1e291d1ac4b0eb86`](https://github.com/SyntheticAutonomicMind/CLIO/commit/1c84ed9cb6161304579123ce1e291d1ac4b0eb86)
...
- [proxysoul/soulforge](https://github.com/proxysoul/soulforge) at [`e6b5885db1232f35a52eb9faeae1023ab46d5685`](https://github.com/proxysoul/soulforge/commit/e6b5885db1232f35a52eb9faeae1023ab46d5685)
