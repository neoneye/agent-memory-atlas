...
[MemPalace](../../systems/mempalace/) makes verbatim drawers the retrieval floor and treats extracted structures as navigation aids. [Honcho](../../systems/honcho/) keeps message streams and derives peer representations. [RainBox](../../systems/rainbox/) separates claims from evidence rows. [Verel](../../systems/verel/) carries provenance through its trust model. [Swafra](../../systems/swafra/) preserves chunk text, but its source metadata is thin. These systems show different strengths of the same pattern.
