...
| --- | --- |
| Scope enforced in retrieval | 128 of 224 |
| Append-only mutation audit | 67 of 224 |
| Human review surface | 55 of 224 |
| Negative retrieval assertion | 48 of 224 |
| Explicit trust state | 42 of 224 |
| Bi-temporal validity | 27 of 224 |
| Rejected-value tombstone | 11 of 224 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty-four — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty-four systems carry a
