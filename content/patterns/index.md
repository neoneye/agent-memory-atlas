...
| --- | --- |
| Scope enforced in retrieval | 169 of 316 |
| Negative retrieval assertion | 92 of 316 |
| Append-only mutation audit | 90 of 316 |
| Human review surface | 80 of 316 |
| Explicit trust state | 66 of 316 |
| Bi-temporal validity | 35 of 316 |
| Rejected-value tombstone | 21 of 316 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and sixteen — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-one of three hundred and sixteen systems carry a
