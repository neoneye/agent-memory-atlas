...
| --- | --- |
| Scope enforced in retrieval | 117 of 200 |
| Append-only mutation audit | 61 of 200 |
| Human review surface | 50 of 200 |
| Negative retrieval assertion | 43 of 200 |
| Explicit trust state | 37 of 200 |
| Bi-temporal validity | 25 of 200 |
| Rejected-value tombstone | 11 of 200 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred systems carry a
