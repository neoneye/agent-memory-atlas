...
| --- | --- |
| Scope enforced in retrieval | 213 of 400 |
| Negative retrieval assertion | 152 of 400 |
| Append-only mutation audit | 131 of 400 |
| Human review surface | 114 of 400 |
| Explicit trust state | 90 of 400 |
| Bi-temporal validity | 56 of 400 |
| Rejected-value tombstone | 33 of 400 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of four hundred — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-three of four hundred systems carry a
