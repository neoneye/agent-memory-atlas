...
| --- | --- |
| Scope enforced in retrieval | 114 of 193 |
| Append-only mutation audit | 59 of 193 |
| Human review surface | 49 of 193 |
| Negative retrieval assertion | 42 of 193 |
| Explicit trust state | 37 of 193 |
| Bi-temporal validity | 24 of 193 |
| Rejected-value tombstone | 11 of 193 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and ninety-three — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of one hundred and ninety-three systems carry a
