...
| --- | --- |
| Scope enforced in retrieval | 133 of 237 |
| Append-only mutation audit | 67 of 237 |
| Human review surface | 58 of 237 |
| Negative retrieval assertion | 49 of 237 |
| Explicit trust state | 45 of 237 |
| Bi-temporal validity | 28 of 237 |
| Rejected-value tombstone | 11 of 237 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and thirty-seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and thirty-seven systems carry a
