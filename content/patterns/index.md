...
| --- | --- |
| Scope enforced in retrieval | 209 of 396 |
| Negative retrieval assertion | 148 of 396 |
| Append-only mutation audit | 129 of 396 |
| Human review surface | 113 of 396 |
| Explicit trust state | 86 of 396 |
| Bi-temporal validity | 54 of 396 |
| Rejected-value tombstone | 32 of 396 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and ninety-six — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-two of three hundred and ninety-six systems carry a
