...
| --- | --- |
| Scope enforced in retrieval | 216 of 421 |
| Negative retrieval assertion | 170 of 421 |
| Append-only mutation audit | 140 of 421 |
| Human review surface | 122 of 421 |
| Explicit trust state | 97 of 421 |
| Bi-temporal validity | 64 of 421 |
| Rejected-value tombstone | 35 of 421 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-five
systems of four hundred and twenty-one — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-five of four hundred and twenty-one systems carry a
