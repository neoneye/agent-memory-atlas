...
| --- | --- |
| Scope enforced in retrieval | 122 of 211 |
| Append-only mutation audit | 65 of 211 |
| Human review surface | 54 of 211 |
| Negative retrieval assertion | 47 of 211 |
| Explicit trust state | 41 of 211 |
| Bi-temporal validity | 27 of 211 |
| Rejected-value tombstone | 11 of 211 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and eleven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and eleven systems carry a
