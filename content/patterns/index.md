...
| --- | --- |
| Scope enforced in retrieval | 151 of 278 |
| Append-only mutation audit | 78 of 278 |
| Human review surface | 71 of 278 |
| Negative retrieval assertion | 69 of 278 |
| Explicit trust state | 55 of 278 |
| Bi-temporal validity | 31 of 278 |
| Rejected-value tombstone | 14 of 278 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and seventy-eight — or in nine — is **not a best
...
**And be clear about what that thinning means.** Fourteen of two hundred and seventy-eight systems carry a
