...
| --- | --- |
| Scope enforced in retrieval | 119 of 207 |
| Append-only mutation audit | 64 of 207 |
| Human review surface | 52 of 207 |
| Negative retrieval assertion | 45 of 207 |
| Explicit trust state | 38 of 207 |
| Bi-temporal validity | 26 of 207 |
| Rejected-value tombstone | 11 of 207 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and seven systems carry a
