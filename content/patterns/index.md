...
| --- | --- |
| Scope enforced in retrieval | 53 of 93 |
| Human review surface | 16 of 93 |
| Append-only mutation audit | 11 of 93 |
| Bi-temporal validity | 8 of 93 |
| Negative retrieval assertion | 8 of 93 |
| Explicit trust state | 7 of 93 |
| Rejected-value tombstone | 3 of 93 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of ninety-three is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of ninety-three systems carry a
