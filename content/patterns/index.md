...
| --- | --- |
| Scope enforced in retrieval | 214 of 406 |
| Negative retrieval assertion | 155 of 406 |
| Append-only mutation audit | 132 of 406 |
| Human review surface | 114 of 406 |
| Explicit trust state | 91 of 406 |
| Bi-temporal validity | 56 of 406 |
| Rejected-value tombstone | 33 of 406 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of four hundred and six — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-three of four hundred and six systems carry a
