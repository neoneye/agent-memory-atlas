...
| --- | --- |
| Scope enforced in retrieval | 109 of 187 |
| Append-only mutation audit | 54 of 187 |
| Human review surface | 47 of 187 |
| Negative retrieval assertion | 42 of 187 |
| Explicit trust state | 35 of 187 |
| Bi-temporal validity | 24 of 187 |
| Rejected-value tombstone | 10 of 187 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and eighty-seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Ten of one hundred and eighty-seven systems carry a
