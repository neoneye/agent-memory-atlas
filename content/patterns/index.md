...
| --- | --- |
| Scope enforced in retrieval | 87 of 154 |
| Human review surface | 38 of 154 |
| Append-only mutation audit | 36 of 154 |
| Negative retrieval assertion | 29 of 154 |
| Explicit trust state | 27 of 154 |
| Bi-temporal validity | 15 of 154 |
| Rejected-value tombstone | 9 of 154 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and fifty-four is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Nine of one hundred and fifty-four systems carry a
