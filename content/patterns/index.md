...
| --- | --- |
| Scope enforced in retrieval | 171 of 320 |
| Negative retrieval assertion | 96 of 320 |
| Append-only mutation audit | 92 of 320 |
| Human review surface | 83 of 320 |
| Explicit trust state | 68 of 320 |
| Bi-temporal validity | 36 of 320 |
| Rejected-value tombstone | 22 of 320 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and twenty — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-two of three hundred and twenty systems carry a
