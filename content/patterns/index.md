...
| --- | --- |
| Scope enforced in retrieval | 197 of 377 |
| Negative retrieval assertion | 137 of 377 |
| Append-only mutation audit | 117 of 377 |
| Human review surface | 103 of 377 |
| Explicit trust state | 81 of 377 |
| Bi-temporal validity | 51 of 377 |
| Rejected-value tombstone | 30 of 377 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and seventy-seven — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty of three hundred and seventy-seven systems carry a
