...
| --- | --- |
| Scope enforced in retrieval | 45 of 75 |
| Human review surface | 14 of 75 |
| Bi-temporal validity | 8 of 75 |
| Explicit trust state | 7 of 75 |
| Append-only mutation audit | 7 of 75 |
| Rejected-value tombstone | 3 of 75 |
| Negative retrieval assertion | 3 of 75 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of seventy-five is **not a best practice**. There is no consensus
