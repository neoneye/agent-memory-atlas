...
| --- | --- |
| Scope enforced in retrieval | 114 of 196 |
| Append-only mutation audit | 61 of 196 |
| Human review surface | 50 of 196 |
| Negative retrieval assertion | 42 of 196 |
| Explicit trust state | 37 of 196 |
| Bi-temporal validity | 24 of 196 |
| Rejected-value tombstone | 11 of 196 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and ninety-six — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of one hundred and ninety-six systems carry a
