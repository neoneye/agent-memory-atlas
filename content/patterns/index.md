...
| --- | --- |
| Scope enforced in retrieval | 156 of 285 |
| Append-only mutation audit | 80 of 285 |
| Human review surface | 73 of 285 |
| Negative retrieval assertion | 72 of 285 |
| Explicit trust state | 58 of 285 |
| Bi-temporal validity | 32 of 285 |
| Rejected-value tombstone | 16 of 285 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and eighty-five — or in nine — is **not a best
...
**And be clear about what that thinning means.** Sixteen of two hundred and eighty-five systems carry a
