...
| --- | --- |
| Scope enforced in retrieval | 128 of 220 |
| Append-only mutation audit | 66 of 220 |
| Human review surface | 54 of 220 |
| Negative retrieval assertion | 48 of 220 |
| Explicit trust state | 42 of 220 |
| Bi-temporal validity | 27 of 220 |
| Rejected-value tombstone | 11 of 220 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty systems carry a
