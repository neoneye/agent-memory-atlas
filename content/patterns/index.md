...
| --- | --- |
| Scope enforced in retrieval | 214 of 405 |
| Negative retrieval assertion | 154 of 405 |
| Append-only mutation audit | 132 of 405 |
| Human review surface | 114 of 405 |
| Explicit trust state | 91 of 405 |
| Bi-temporal validity | 56 of 405 |
| Rejected-value tombstone | 33 of 405 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of four hundred and five — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-three of four hundred and five systems carry a
