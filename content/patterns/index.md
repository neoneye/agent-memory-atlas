...
| --- | --- |
| Scope enforced in retrieval | 167 of 310 |
| Append-only mutation audit | 90 of 310 |
| Negative retrieval assertion | 89 of 310 |
| Human review surface | 80 of 310 |
| Explicit trust state | 66 of 310 |
| Bi-temporal validity | 35 of 310 |
| Rejected-value tombstone | 21 of 310 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and ten — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-one of three hundred and ten systems carry a
