...
| --- | --- |
| Scope enforced in retrieval | 232 of 461 |
| Negative retrieval assertion | 230 of 461 |
| Append-only mutation audit | 162 of 461 |
| Human review surface | 139 of 461 |
| Explicit trust state | 104 of 461 |
| Bi-temporal validity | 72 of 461 |
| Rejected-value tombstone | 44 of 461 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-eight
systems of four hundred and sixty-one — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Forty-four of four hundred and sixty-one systems carry a
