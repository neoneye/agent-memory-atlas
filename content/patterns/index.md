...
| --- | --- |
| Scope enforced in retrieval | 65 of 119 |
| Human review surface | 24 of 119 |
| Append-only mutation audit | 17 of 119 |
| Negative retrieval assertion | 16 of 119 |
| Explicit trust state | 11 of 119 |
| Bi-temporal validity | 9 of 119 |
| Rejected-value tombstone | 3 of 119 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and nineteen is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and nineteen systems carry a
