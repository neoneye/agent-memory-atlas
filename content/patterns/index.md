...
| --- | --- |
| Scope enforced in retrieval | 128 of 222 |
| Append-only mutation audit | 67 of 222 |
| Human review surface | 54 of 222 |
| Negative retrieval assertion | 48 of 222 |
| Explicit trust state | 42 of 222 |
| Bi-temporal validity | 27 of 222 |
| Rejected-value tombstone | 11 of 222 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty-two — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty-two systems carry a
