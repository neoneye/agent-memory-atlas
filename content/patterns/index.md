...
| --- | --- |
| Scope enforced in retrieval | 128 of 223 |
| Append-only mutation audit | 67 of 223 |
| Human review surface | 55 of 223 |
| Negative retrieval assertion | 48 of 223 |
| Explicit trust state | 42 of 223 |
| Bi-temporal validity | 27 of 223 |
| Rejected-value tombstone | 11 of 223 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty-three — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty-three systems carry a
