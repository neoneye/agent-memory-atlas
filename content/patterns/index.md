...
| --- | --- |
| Scope enforced in retrieval | 73 of 135 |
| Human review surface | 28 of 135 |
| Append-only mutation audit | 23 of 135 |
| Explicit trust state | 18 of 135 |
| Negative retrieval assertion | 17 of 135 |
| Bi-temporal validity | 10 of 135 |
| Rejected-value tombstone | 4 of 135 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and thirty-four is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Four of one hundred and thirty-four systems carry a
