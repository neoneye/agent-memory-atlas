...
| --- | --- |
| Scope enforced in retrieval | 130 of 229 |
| Append-only mutation audit | 67 of 229 |
| Human review surface | 57 of 229 |
| Negative retrieval assertion | 48 of 229 |
| Explicit trust state | 42 of 229 |
| Bi-temporal validity | 27 of 229 |
| Rejected-value tombstone | 11 of 229 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty-nine — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty-nine systems carry a
