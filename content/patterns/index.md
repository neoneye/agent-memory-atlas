...
| --- | --- |
| Scope enforced in retrieval | 71 of 131 |
| Human review surface | 27 of 131 |
| Append-only mutation audit | 21 of 131 |
| Explicit trust state | 17 of 131 |
| Negative retrieval assertion | 17 of 131 |
| Bi-temporal validity | 9 of 131 |
| Rejected-value tombstone | 4 of 131 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and thirty-one is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Four of one hundred and thirty-one systems carry a
