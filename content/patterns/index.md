...
| --- | --- |
| Scope enforced in retrieval | 133 of 236 |
| Append-only mutation audit | 67 of 236 |
| Human review surface | 58 of 236 |
| Negative retrieval assertion | 49 of 236 |
| Explicit trust state | 45 of 236 |
| Bi-temporal validity | 28 of 236 |
| Rejected-value tombstone | 11 of 236 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and thirty-six — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and thirty-six systems carry a
