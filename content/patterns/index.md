...
| --- | --- |
| Scope enforced in retrieval | 113 of 192 |
| Append-only mutation audit | 58 of 192 |
| Human review surface | 49 of 192 |
| Negative retrieval assertion | 42 of 192 |
| Explicit trust state | 37 of 192 |
| Bi-temporal validity | 24 of 192 |
| Rejected-value tombstone | 11 of 192 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and ninety-two — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of one hundred and ninety-two systems carry a
