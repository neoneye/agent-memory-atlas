...
| --- | --- |
| Scope enforced in retrieval | 95 of 166 |
| Append-only mutation audit | 42 of 166 |
| Human review surface | 42 of 166 |
| Negative retrieval assertion | 37 of 166 |
| Explicit trust state | 31 of 166 |
| Bi-temporal validity | 18 of 166 |
| Rejected-value tombstone | 9 of 166 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and sixty-six — or in nine — is **not a best
...
**And be clear about what that thinning means.** Nine of one hundred and sixty-six systems carry a
