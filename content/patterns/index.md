...
| --- | --- |
| Scope enforced in retrieval | 144 of 267 |
| Append-only mutation audit | 75 of 267 |
| Human review surface | 68 of 267 |
| Negative retrieval assertion | 66 of 267 |
| Explicit trust state | 54 of 267 |
| Bi-temporal validity | 30 of 267 |
| Rejected-value tombstone | 13 of 267 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and sixty-seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Thirteen of two hundred and sixty-seven systems carry a
