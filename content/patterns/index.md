...
| --- | --- |
| Scope enforced in retrieval | 138 of 248 |
| Append-only mutation audit | 70 of 248 |
| Human review surface | 61 of 248 |
| Negative retrieval assertion | 54 of 248 |
| Explicit trust state | 48 of 248 |
| Bi-temporal validity | 28 of 248 |
| Rejected-value tombstone | 12 of 248 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and forty-eight — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and forty-eight systems carry a
