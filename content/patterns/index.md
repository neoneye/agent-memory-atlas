...
| --- | --- |
| Scope enforced in retrieval | 117 of 202 |
| Append-only mutation audit | 62 of 202 |
| Human review surface | 51 of 202 |
| Negative retrieval assertion | 44 of 202 |
| Explicit trust state | 37 of 202 |
| Bi-temporal validity | 25 of 202 |
| Rejected-value tombstone | 11 of 202 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and two — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and two systems carry a
