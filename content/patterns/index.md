...
| --- | --- |
| Scope enforced in retrieval | 136 of 243 |
| Append-only mutation audit | 68 of 243 |
| Human review surface | 59 of 243 |
| Negative retrieval assertion | 51 of 243 |
| Explicit trust state | 46 of 243 |
| Bi-temporal validity | 28 of 243 |
| Rejected-value tombstone | 12 of 243 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and forty-three — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and forty-three systems carry a
