...
| --- | --- |
| Scope enforced in retrieval | 61 of 111 |
| Human review surface | 19 of 111 |
| Append-only mutation audit | 15 of 111 |
| Negative retrieval assertion | 14 of 111 |
| Explicit trust state | 9 of 111 |
| Bi-temporal validity | 9 of 111 |
| Rejected-value tombstone | 3 of 111 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and eleven is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and eleven systems carry a
