...
| --- | --- |
| Scope enforced in retrieval | 63 of 115 |
| Human review surface | 21 of 115 |
| Append-only mutation audit | 17 of 115 |
| Negative retrieval assertion | 16 of 115 |
| Explicit trust state | 11 of 115 |
| Bi-temporal validity | 9 of 115 |
| Rejected-value tombstone | 3 of 115 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and fifteen is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and fifteen systems carry a
