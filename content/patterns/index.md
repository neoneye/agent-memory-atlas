...
| --- | --- |
| Scope enforced in retrieval | 143 of 265 |
| Append-only mutation audit | 74 of 265 |
| Human review surface | 67 of 265 |
| Negative retrieval assertion | 65 of 265 |
| Explicit trust state | 53 of 265 |
| Bi-temporal validity | 30 of 265 |
| Rejected-value tombstone | 13 of 265 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and sixty-five — or in nine — is **not a best
...
**And be clear about what that thinning means.** Thirteen of two hundred and sixty-five systems carry a
