...
| --- | --- |
| Scope enforced in retrieval | 115 of 198 |
| Append-only mutation audit | 61 of 198 |
| Human review surface | 50 of 198 |
| Negative retrieval assertion | 42 of 198 |
| Explicit trust state | 37 of 198 |
| Bi-temporal validity | 24 of 198 |
| Rejected-value tombstone | 11 of 198 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and ninety-eight — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of one hundred and ninety-eight systems carry a
