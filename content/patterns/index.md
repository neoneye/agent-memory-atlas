...
| --- | --- |
| Scope enforced in retrieval | 127 of 219 |
| Append-only mutation audit | 65 of 219 |
| Human review surface | 54 of 219 |
| Negative retrieval assertion | 48 of 219 |
| Explicit trust state | 42 of 219 |
| Bi-temporal validity | 27 of 219 |
| Rejected-value tombstone | 11 of 219 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and nineteen — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and nineteen systems carry a
