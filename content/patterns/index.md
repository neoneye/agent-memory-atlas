...
| --- | --- |
| Scope enforced in retrieval | 160 of 293 |
| Append-only mutation audit | 84 of 293 |
| Negative retrieval assertion | 78 of 293 |
| Human review surface | 76 of 293 |
| Explicit trust state | 61 of 293 |
| Bi-temporal validity | 34 of 293 |
| Rejected-value tombstone | 19 of 293 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of two hundred and ninety-three — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Nineteen of two hundred and ninety-three systems carry a
