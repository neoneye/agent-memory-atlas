...
| --- | --- |
| Scope enforced in retrieval | 117 of 201 |
| Append-only mutation audit | 61 of 201 |
| Human review surface | 50 of 201 |
| Negative retrieval assertion | 43 of 201 |
| Explicit trust state | 37 of 201 |
| Bi-temporal validity | 25 of 201 |
| Rejected-value tombstone | 11 of 201 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and one — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and one systems carry a
