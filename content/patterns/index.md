...
| --- | --- |
| Scope enforced in retrieval | 138 of 247 |
| Append-only mutation audit | 69 of 247 |
| Human review surface | 60 of 247 |
| Negative retrieval assertion | 54 of 247 |
| Explicit trust state | 47 of 247 |
| Bi-temporal validity | 28 of 247 |
| Rejected-value tombstone | 12 of 247 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and forty-seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and forty-seven systems carry a
