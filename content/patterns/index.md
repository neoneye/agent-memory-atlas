...
| --- | --- |
| Scope enforced in retrieval | 61 of 109 |
| Human review surface | 19 of 109 |
| Append-only mutation audit | 13 of 109 |
| Negative retrieval assertion | 12 of 109 |
| Explicit trust state | 9 of 109 |
| Bi-temporal validity | 9 of 109 |
| Rejected-value tombstone | 3 of 109 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and nine is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and nine systems carry a
