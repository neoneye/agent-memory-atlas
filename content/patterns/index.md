...
| --- | --- |
| Scope enforced in retrieval | 186 of 354 |
| Negative retrieval assertion | 124 of 354 |
| Append-only mutation audit | 109 of 354 |
| Human review surface | 94 of 354 |
| Explicit trust state | 75 of 354 |
| Bi-temporal validity | 47 of 354 |
| Rejected-value tombstone | 26 of 354 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and fifty-four — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-six of three hundred and fifty-four systems carry a
