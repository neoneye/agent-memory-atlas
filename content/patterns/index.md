...
| --- | --- |
| Scope enforced in retrieval | 130 of 228 |
| Append-only mutation audit | 67 of 228 |
| Human review surface | 57 of 228 |
| Negative retrieval assertion | 48 of 228 |
| Explicit trust state | 42 of 228 |
| Bi-temporal validity | 27 of 228 |
| Rejected-value tombstone | 11 of 228 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty-eight — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty-eight systems carry a
