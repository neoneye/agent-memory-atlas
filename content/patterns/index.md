...
| --- | --- |
| Scope enforced in retrieval | 130 of 227 |
| Append-only mutation audit | 67 of 227 |
| Human review surface | 56 of 227 |
| Negative retrieval assertion | 48 of 227 |
| Explicit trust state | 42 of 227 |
| Bi-temporal validity | 27 of 227 |
| Rejected-value tombstone | 11 of 227 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and twenty-seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and twenty-seven systems carry a
