...
| --- | --- |
| Scope enforced in retrieval | 87 of 155 |
| Append-only mutation audit | 39 of 155 |
| Human review surface | 39 of 155 |
| Negative retrieval assertion | 30 of 155 |
| Explicit trust state | 28 of 155 |
| Bi-temporal validity | 16 of 155 |
| Rejected-value tombstone | 9 of 155 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and fifty-five is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Nine of one hundred and fifty-five systems carry a
