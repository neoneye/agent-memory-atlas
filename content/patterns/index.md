...
| --- | --- |
| Scope enforced in retrieval | 139 of 251 |
| Append-only mutation audit | 70 of 251 |
| Human review surface | 61 of 251 |
| Negative retrieval assertion | 56 of 251 |
| Explicit trust state | 48 of 251 |
| Bi-temporal validity | 28 of 251 |
| Rejected-value tombstone | 12 of 251 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and fifty-one — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and fifty-one systems carry a
