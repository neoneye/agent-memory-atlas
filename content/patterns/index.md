...
| --- | --- |
| Scope enforced in retrieval | 210 of 397 |
| Negative retrieval assertion | 149 of 397 |
| Append-only mutation audit | 129 of 397 |
| Human review surface | 113 of 397 |
| Explicit trust state | 87 of 397 |
| Bi-temporal validity | 54 of 397 |
| Rejected-value tombstone | 32 of 397 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and ninety-seven — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-two of three hundred and ninety-seven systems carry a
