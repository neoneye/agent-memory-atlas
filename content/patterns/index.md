...
| --- | --- |
| Scope enforced in retrieval | 118 of 205 |
| Append-only mutation audit | 63 of 205 |
| Human review surface | 51 of 205 |
| Negative retrieval assertion | 45 of 205 |
| Explicit trust state | 38 of 205 |
| Bi-temporal validity | 26 of 205 |
| Rejected-value tombstone | 11 of 205 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and five — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and five systems carry a
