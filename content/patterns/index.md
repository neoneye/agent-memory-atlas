...
| --- | --- |
| Scope enforced in retrieval | 127 of 218 |
| Append-only mutation audit | 65 of 218 |
| Human review surface | 54 of 218 |
| Negative retrieval assertion | 48 of 218 |
| Explicit trust state | 42 of 218 |
| Bi-temporal validity | 27 of 218 |
| Rejected-value tombstone | 11 of 218 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and eighteen — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and eighteen systems carry a
