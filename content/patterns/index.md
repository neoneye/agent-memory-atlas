...
| --- | --- |
| Scope enforced in retrieval | 69 of 124 |
| Human review surface | 26 of 124 |
| Append-only mutation audit | 19 of 124 |
| Negative retrieval assertion | 17 of 124 |
| Explicit trust state | 12 of 124 |
| Bi-temporal validity | 9 of 124 |
| Rejected-value tombstone | 4 of 124 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and twenty-four is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Four of one hundred and twenty-four systems carry a
