...
| --- | --- |
| Scope enforced in retrieval | 54 of 94 |
| Human review surface | 16 of 94 |
| Append-only mutation audit | 11 of 94 |
| Negative retrieval assertion | 9 of 94 |
| Bi-temporal validity | 8 of 94 |
| Explicit trust state | 7 of 94 |
| Rejected-value tombstone | 3 of 94 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of ninety-four is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of ninety-four systems carry a
