...
| --- | --- |
| Scope enforced in retrieval | 122 of 210 |
| Append-only mutation audit | 65 of 210 |
| Human review surface | 54 of 210 |
| Negative retrieval assertion | 46 of 210 |
| Explicit trust state | 40 of 210 |
| Bi-temporal validity | 27 of 210 |
| Rejected-value tombstone | 11 of 210 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and ten — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and ten systems carry a
