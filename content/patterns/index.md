...
| --- | --- |
| Scope enforced in retrieval | 77 of 141 |
| Human review surface | 29 of 141 |
| Append-only mutation audit | 25 of 141 |
| Explicit trust state | 19 of 141 |
| Negative retrieval assertion | 17 of 141 |
| Bi-temporal validity | 10 of 141 |
| Rejected-value tombstone | 4 of 141 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and forty-one is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Four of one hundred and forty-one systems carry a
