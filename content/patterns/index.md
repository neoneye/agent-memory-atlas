...
| --- | --- |
| Scope enforced in retrieval | 142 of 263 |
| Append-only mutation audit | 74 of 263 |
| Human review surface | 67 of 263 |
| Negative retrieval assertion | 64 of 263 |
| Explicit trust state | 51 of 263 |
| Bi-temporal validity | 30 of 263 |
| Rejected-value tombstone | 13 of 263 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and sixty-three — or in nine — is **not a best
...
**And be clear about what that thinning means.** Thirteen of two hundred and sixty-three systems carry a
