...
| --- | --- |
| Scope enforced in retrieval | 232 of 460 |
| Negative retrieval assertion | 229 of 460 |
| Append-only mutation audit | 161 of 460 |
| Human review surface | 138 of 460 |
| Explicit trust state | 104 of 460 |
| Bi-temporal validity | 72 of 460 |
| Rejected-value tombstone | 44 of 460 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-eight
systems of four hundred and sixty — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Forty-four of four hundred and sixty systems carry a
