...
| --- | --- |
| Scope enforced in retrieval | 131 of 230 |
| Append-only mutation audit | 67 of 230 |
| Human review surface | 57 of 230 |
| Negative retrieval assertion | 48 of 230 |
| Explicit trust state | 42 of 230 |
| Bi-temporal validity | 28 of 230 |
| Rejected-value tombstone | 11 of 230 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and thirty — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and thirty systems carry a
