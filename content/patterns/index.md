...
| --- | --- |
| Scope enforced in retrieval | 163 of 300 |
| Append-only mutation audit | 86 of 300 |
| Negative retrieval assertion | 81 of 300 |
| Human review surface | 79 of 300 |
| Explicit trust state | 63 of 300 |
| Bi-temporal validity | 34 of 300 |
| Rejected-value tombstone | 20 of 300 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty of three hundred systems carry a
