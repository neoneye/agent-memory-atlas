...
| --- | --- |
| Scope enforced in retrieval | 42 of 71 |
| Human review surface | 12 of 71 |
| Bi-temporal validity | 8 of 71 |
| Append-only mutation audit | 7 of 71 |
| Explicit trust state | 6 of 71 |
| Rejected-value tombstone | 3 of 71 |
| Negative retrieval assertion | 3 of 71 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of seventy-one is **not a best practice**. There is no consensus
