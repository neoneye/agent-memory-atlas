...
| --- | --- |
| Scope enforced in retrieval | 140 of 256 |
| Append-only mutation audit | 72 of 256 |
| Human review surface | 64 of 256 |
| Negative retrieval assertion | 61 of 256 |
| Explicit trust state | 50 of 256 |
| Bi-temporal validity | 28 of 256 |
| Rejected-value tombstone | 12 of 256 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and fifty-six — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and fifty-six systems carry a
