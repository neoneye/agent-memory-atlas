...
| --- | --- |
| Scope enforced in retrieval | 206 of 391 |
| Negative retrieval assertion | 146 of 391 |
| Append-only mutation audit | 126 of 391 |
| Human review surface | 112 of 391 |
| Explicit trust state | 85 of 391 |
| Bi-temporal validity | 54 of 391 |
| Rejected-value tombstone | 32 of 391 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and ninety-one — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty-two of three hundred and ninety-one systems carry a
