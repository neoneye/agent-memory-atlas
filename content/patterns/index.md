...
| --- | --- |
| Scope enforced in retrieval | 69 of 126 |
| Human review surface | 26 of 126 |
| Append-only mutation audit | 20 of 126 |
| Negative retrieval assertion | 17 of 126 |
| Explicit trust state | 13 of 126 |
| Bi-temporal validity | 9 of 126 |
| Rejected-value tombstone | 4 of 126 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and twenty-six is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Four of one hundred and twenty-six systems carry a
