...
| --- | --- |
| Scope enforced in retrieval | 140 of 257 |
| Append-only mutation audit | 72 of 257 |
| Human review surface | 65 of 257 |
| Negative retrieval assertion | 62 of 257 |
| Explicit trust state | 50 of 257 |
| Bi-temporal validity | 28 of 257 |
| Rejected-value tombstone | 13 of 257 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and fifty-seven — or in nine — is **not a best
...
**And be clear about what that thinning means.** Thirteen of two hundred and fifty-seven systems carry a
