...
| --- | --- |
| Scope enforced in retrieval | 197 of 374 |
| Negative retrieval assertion | 137 of 374 |
| Append-only mutation audit | 117 of 374 |
| Human review surface | 103 of 374 |
| Explicit trust state | 81 of 374 |
| Bi-temporal validity | 51 of 374 |
| Rejected-value tombstone | 30 of 374 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and seventy-four — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Thirty of three hundred and seventy-four systems carry a
