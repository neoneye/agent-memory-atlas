...
| --- | --- |
| Scope enforced in retrieval | 60 of 106 |
| Human review surface | 18 of 106 |
| Append-only mutation audit | 12 of 106 |
| Negative retrieval assertion | 11 of 106 |
| Bi-temporal validity | 9 of 106 |
| Explicit trust state | 8 of 106 |
| Rejected-value tombstone | 3 of 106 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and six is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and six systems carry a
