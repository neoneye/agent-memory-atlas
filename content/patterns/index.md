...
| --- | --- |
| Scope enforced in retrieval | 75 of 138 |
| Human review surface | 28 of 138 |
| Append-only mutation audit | 24 of 138 |
| Explicit trust state | 19 of 138 |
| Negative retrieval assertion | 17 of 138 |
| Bi-temporal validity | 10 of 138 |
| Rejected-value tombstone | 4 of 138 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and thirty-eight is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Four of one hundred and thirty-eight systems carry a
