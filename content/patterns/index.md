...
| --- | --- |
| Scope enforced in retrieval | 143 of 264 |
| Append-only mutation audit | 74 of 264 |
| Human review surface | 67 of 264 |
| Negative retrieval assertion | 64 of 264 |
| Explicit trust state | 52 of 264 |
| Bi-temporal validity | 30 of 264 |
| Rejected-value tombstone | 13 of 264 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and sixty-four — or in nine — is **not a best
...
**And be clear about what that thinning means.** Thirteen of two hundred and sixty-four systems carry a
