...
| --- | --- |
| Scope enforced in retrieval | 165 of 302 |
| Append-only mutation audit | 87 of 302 |
| Negative retrieval assertion | 83 of 302 |
| Human review surface | 79 of 302 |
| Explicit trust state | 64 of 302 |
| Bi-temporal validity | 35 of 302 |
| Rejected-value tombstone | 21 of 302 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and two — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-one of three hundred and two systems carry a
