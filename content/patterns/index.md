...
| --- | --- |
| Scope enforced in retrieval | 61 of 108 |
| Human review surface | 19 of 108 |
| Append-only mutation audit | 12 of 108 |
| Negative retrieval assertion | 12 of 108 |
| Bi-temporal validity | 9 of 108 |
| Explicit trust state | 8 of 108 |
| Rejected-value tombstone | 3 of 108 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and eight is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and eight systems carry a
