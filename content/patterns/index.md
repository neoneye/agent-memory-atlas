...
| --- | --- |
| Scope enforced in retrieval | 175 of 329 |
| Negative retrieval assertion | 105 of 329 |
| Append-only mutation audit | 96 of 329 |
| Human review surface | 85 of 329 |
| Explicit trust state | 70 of 329 |
| Bi-temporal validity | 40 of 329 |
| Rejected-value tombstone | 23 of 329 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and twenty-nine — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-three of three hundred and twenty-nine systems carry a
