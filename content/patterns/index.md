...
| --- | --- |
| Scope enforced in retrieval | 117 of 204 |
| Append-only mutation audit | 63 of 204 |
| Human review surface | 51 of 204 |
| Negative retrieval assertion | 45 of 204 |
| Explicit trust state | 38 of 204 |
| Bi-temporal validity | 26 of 204 |
| Rejected-value tombstone | 11 of 204 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and four — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and four systems carry a
