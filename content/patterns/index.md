...
| --- | --- |
| Scope enforced in retrieval | 143 of 266 |
| Append-only mutation audit | 74 of 266 |
| Human review surface | 67 of 266 |
| Negative retrieval assertion | 65 of 266 |
| Explicit trust state | 53 of 266 |
| Bi-temporal validity | 30 of 266 |
| Rejected-value tombstone | 13 of 266 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and sixty-six — or in nine — is **not a best
...
**And be clear about what that thinning means.** Thirteen of two hundred and sixty-six systems carry a
