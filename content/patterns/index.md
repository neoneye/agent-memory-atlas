...
| --- | --- |
| Scope enforced in retrieval | 62 of 113 |
| Human review surface | 19 of 113 |
| Append-only mutation audit | 16 of 113 |
| Negative retrieval assertion | 16 of 113 |
| Explicit trust state | 10 of 113 |
| Bi-temporal validity | 9 of 113 |
| Rejected-value tombstone | 3 of 113 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and thirteen is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and thirteen systems carry a
