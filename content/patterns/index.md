...
| --- | --- |
| Scope enforced in retrieval | 112 of 191 |
| Append-only mutation audit | 57 of 191 |
| Human review surface | 49 of 191 |
| Negative retrieval assertion | 42 of 191 |
| Explicit trust state | 37 of 191 |
| Bi-temporal validity | 24 of 191 |
| Rejected-value tombstone | 11 of 191 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and ninety-one — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of one hundred and ninety-one systems carry a
