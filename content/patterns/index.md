...
| --- | --- |
| Scope enforced in retrieval | 135 of 241 |
| Append-only mutation audit | 68 of 241 |
| Human review surface | 59 of 241 |
| Negative retrieval assertion | 51 of 241 |
| Explicit trust state | 46 of 241 |
| Bi-temporal validity | 28 of 241 |
| Rejected-value tombstone | 12 of 241 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and forty-one — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and forty-one systems carry a
