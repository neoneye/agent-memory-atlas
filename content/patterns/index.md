...
| --- | --- |
| Scope enforced in retrieval | 55 of 96 |
| Human review surface | 16 of 96 |
| Append-only mutation audit | 11 of 96 |
| Negative retrieval assertion | 9 of 96 |
| Bi-temporal validity | 8 of 96 |
| Explicit trust state | 7 of 96 |
| Rejected-value tombstone | 3 of 96 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of ninety-six is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of ninety-six systems carry a
