...
| --- | --- |
| Scope enforced in retrieval | 62 of 112 |
| Human review surface | 19 of 112 |
| Append-only mutation audit | 16 of 112 |
| Negative retrieval assertion | 15 of 112 |
| Explicit trust state | 9 of 112 |
| Bi-temporal validity | 9 of 112 |
| Rejected-value tombstone | 3 of 112 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of one hundred and twelve is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of one hundred and twelve systems carry a
