...
| --- | --- |
| Scope enforced in retrieval | 117 of 203 |
| Append-only mutation audit | 62 of 203 |
| Human review surface | 51 of 203 |
| Negative retrieval assertion | 45 of 203 |
| Explicit trust state | 38 of 203 |
| Bi-temporal validity | 25 of 203 |
| Rejected-value tombstone | 11 of 203 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and three — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and three systems carry a
