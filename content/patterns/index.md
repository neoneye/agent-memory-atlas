...
| --- | --- |
| Scope enforced in retrieval | 136 of 242 |
| Append-only mutation audit | 68 of 242 |
| Human review surface | 59 of 242 |
| Negative retrieval assertion | 51 of 242 |
| Explicit trust state | 46 of 242 |
| Bi-temporal validity | 28 of 242 |
| Rejected-value tombstone | 12 of 242 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and forty-two — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and forty-two systems carry a
