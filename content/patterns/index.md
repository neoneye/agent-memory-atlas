...
| --- | --- |
| Scope enforced in retrieval | 160 of 294 |
| Append-only mutation audit | 84 of 294 |
| Negative retrieval assertion | 78 of 294 |
| Human review surface | 76 of 294 |
| Explicit trust state | 61 of 294 |
| Bi-temporal validity | 34 of 294 |
| Rejected-value tombstone | 19 of 294 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of two hundred and ninety-four — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Nineteen of two hundred and ninety-four systems carry a
