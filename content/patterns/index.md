...
| --- | --- |
| Scope enforced in retrieval | 54 of 95 |
| Human review surface | 16 of 95 |
| Append-only mutation audit | 11 of 95 |
| Negative retrieval assertion | 9 of 95 |
| Bi-temporal validity | 8 of 95 |
| Explicit trust state | 7 of 95 |
| Rejected-value tombstone | 3 of 95 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in two or three
systems out of ninety-five is **not a best practice**. There is no consensus
...
**And be clear about what that thinning means.** Three of ninety-five systems carry a
