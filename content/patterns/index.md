...
| --- | --- |
| Scope enforced in retrieval | 140 of 255 |
| Append-only mutation audit | 72 of 255 |
| Human review surface | 64 of 255 |
| Negative retrieval assertion | 60 of 255 |
| Explicit trust state | 50 of 255 |
| Bi-temporal validity | 28 of 255 |
| Rejected-value tombstone | 12 of 255 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and fifty-five — or in nine — is **not a best
...
**And be clear about what that thinning means.** Twelve of two hundred and fifty-five systems carry a
