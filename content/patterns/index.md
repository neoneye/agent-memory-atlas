...
| --- | --- |
| Scope enforced in retrieval | 123 of 214 |
| Append-only mutation audit | 65 of 214 |
| Human review surface | 54 of 214 |
| Negative retrieval assertion | 47 of 214 |
| Explicit trust state | 41 of 214 |
| Bi-temporal validity | 27 of 214 |
| Rejected-value tombstone | 11 of 214 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and fourteen — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and fourteen systems carry a
