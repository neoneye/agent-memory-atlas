...
| --- | --- |
| Scope enforced in retrieval | 114 of 195 |
| Append-only mutation audit | 60 of 195 |
| Human review surface | 50 of 195 |
| Negative retrieval assertion | 42 of 195 |
| Explicit trust state | 37 of 195 |
| Bi-temporal validity | 24 of 195 |
| Rejected-value tombstone | 11 of 195 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of one hundred and ninety-five — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of one hundred and ninety-five systems carry a
