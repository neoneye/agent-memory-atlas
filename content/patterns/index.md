...
| --- | --- |
| Scope enforced in retrieval | 165 of 303 |
| Append-only mutation audit | 88 of 303 |
| Negative retrieval assertion | 84 of 303 |
| Human review surface | 79 of 303 |
| Explicit trust state | 65 of 303 |
| Bi-temporal validity | 35 of 303 |
| Rejected-value tombstone | 21 of 303 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in thirty-three
systems of three hundred and three — or in nineteen — is **not a best
...
**And be clear about what that thinning means.** Twenty-one of three hundred and three systems carry a
