...
| --- | --- |
| Scope enforced in retrieval | 119 of 206 |
| Append-only mutation audit | 64 of 206 |
| Human review surface | 52 of 206 |
| Negative retrieval assertion | 45 of 206 |
| Explicit trust state | 38 of 206 |
| Bi-temporal validity | 26 of 206 |
| Rejected-value tombstone | 11 of 206 |
<!-- END GENERATED SPREAD -->

Read the bottom two rows as what they are. A mechanism present in seventeen
systems of two hundred and six — or in nine — is **not a best
...
**And be clear about what that thinning means.** Eleven of two hundred and six systems carry a
