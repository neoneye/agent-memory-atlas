...
MateClaw still has **no deletion hook**, so it closes half the governance gap and leaves the other half open. That is the current state of the art in this atlas: one contract of five carries scope, none carries deletion.
