...
> **This is not an established best practice.** Four systems of one hundred and thirty-one
...
That makes the negative result stronger rather than weaker. Two of one hundred and thirty-one
would suggest a hard idea that a few teams reach independently. One of
one hundred and thirty-one, plus one adoption by a reader who went looking, suggests an idea
