...
> **This is not an established best practice.** Six systems of one hundred and forty-nine
...
That makes the negative result stronger rather than weaker. Two of one hundred and forty-nine
would suggest a hard idea that a few teams reach independently. One of
one hundred and forty-nine, plus one adoption by a reader who went looking, suggests an idea
