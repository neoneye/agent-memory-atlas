...
> **This is not an established best practice.** Nine systems of one hundred and eighty-two
...
That makes the negative result stronger rather than weaker. Two of one hundred and eighty-two
would suggest a hard idea that a few teams reach independently. One of
one hundred and eighty-one, plus one adoption by a reader who went looking, suggests an idea
