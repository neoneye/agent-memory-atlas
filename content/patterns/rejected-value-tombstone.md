...
> **This is not an established best practice.** Three systems of one hundred and thirteen
...
That makes the negative result stronger rather than weaker. Two of one hundred and thirteen
would suggest a hard idea that a few teams reach independently. One of
one hundred and thirteen, plus one adoption by a reader who went looking, suggests an idea
