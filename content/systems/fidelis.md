...
revision: 318a5cbbe46286e15fcdc563338e2411f35e104b
revision_url: https://github.com/hermes-labs-ai/fidelis/commit/318a5cbbe46286e15fcdc563338e2411f35e104b
analyzed_at: 2026-09-17
capabilities: "scope_enforced"
capability_evidence:
  scope_enforced: "every read path | src/fidelis/degrade.py:125 and src/fidelis/server.py:390, :435 | `user_id` is written into the record payload and passed as `filters={\"user_id\": user_id}` by all six readers — the two server lanes, recall_b, recall_hybrid, calibrate and snapshot | unknown"
