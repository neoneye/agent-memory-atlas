...
revision: 4b91fa74b922890b4e5fc3e391f9db6edb89daec
revision_url: https://github.com/agentic-box/memora/commit/4b91fa74b922890b4e5fc3e391f9db6edb89daec
...
The advisory half of the write path is unaffected and still worth the praise it had: `_infer_type` and `_suggest_tags` return suggestions in the response and write nothing, which is a different and stronger claim — there is no argument that turns them into writers. `tombstone`, `audit_log` and `negative_eval` hold.
