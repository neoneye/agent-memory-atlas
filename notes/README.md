...
- [2026-09-25-splitting-the-overview.md](2026-09-25-splitting-the-overview.md) —
  ...
  `/compare/` is now the matrix alone, the synthesis is `/overview/` at the
  same file path, §1 and §11 have pages of their own, and 104 moved ids
...
- [2026-09-09-benchmark-hygiene-and-a-register.md](2026-09-09-benchmark-hygiene-and-a-register.md) —
  ...
  training exposure, and an archive containing a prior-edition import does not
  establish saturation-driven retirement. Proposes a compact name index linked
  to the existing essays, with evidence per release, explicit unknowns, and
  result-specific cost and reproduction status. Includes a pinned source check
  and a bounded three-benchmark pilot; the register remains a proposal.
