...
**Progress: 409 of 470 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 224 |
| Repositories with build-time execution (`EXEC`) | 295 |
