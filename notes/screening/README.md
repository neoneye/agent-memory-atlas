...
**Progress: 524 of 576 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 317 |
| Repositories with build-time execution (`EXEC`) | 386 |
