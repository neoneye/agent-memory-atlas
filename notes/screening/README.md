...
**Progress: 486 of 547 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 297 |
| Repositories with build-time execution (`EXEC`) | 355 |
