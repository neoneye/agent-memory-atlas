...
**Progress: 488 of 549 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 299 |
| Repositories with build-time execution (`EXEC`) | 356 |
