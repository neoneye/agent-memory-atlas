...
**Progress: 453 of 514 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 266 |
| Repositories with build-time execution (`EXEC`) | 332 |
