...
**Progress: 322 of 439 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 160 |
| Repositories with build-time execution (`EXEC`) | 241 |
