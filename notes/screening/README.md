...
**Progress: 320 of 437 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 158 |
| Repositories with build-time execution (`EXEC`) | 239 |
