...
**Progress: 307 of 424 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 150 |
| Repositories with build-time execution (`EXEC`) | 228 |
