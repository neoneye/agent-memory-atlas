...
**Progress: 443 of 504 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 256 |
| Repositories with build-time execution (`EXEC`) | 325 |
