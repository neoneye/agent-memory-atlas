...
**Progress: 410 of 471 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 225 |
| Repositories with build-time execution (`EXEC`) | 296 |
