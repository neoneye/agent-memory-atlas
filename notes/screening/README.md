...
**Progress: 200 of 348 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 75 |
| Repositories with build-time execution (`EXEC`) | 155 |
