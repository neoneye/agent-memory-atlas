...
**Progress: 455 of 516 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 268 |
| Repositories with build-time execution (`EXEC`) | 334 |
