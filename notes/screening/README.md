...
**Progress: 460 of 521 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 273 |
| Repositories with build-time execution (`EXEC`) | 339 |
