...
**Progress: 435 of 496 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 250 |
| Repositories with build-time execution (`EXEC`) | 317 |
