...
**Progress: 256 of 395 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 111 |
| Repositories with build-time execution (`EXEC`) | 190 |
