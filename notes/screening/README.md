...
**Progress: 156 of 314 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 47 |
| Repositories with build-time execution (`EXEC`) | 125 |
