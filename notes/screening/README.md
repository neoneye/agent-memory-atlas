...
**Progress: 149 of 310 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 44 |
| Repositories with build-time execution (`EXEC`) | 119 |
