...
**Progress: 442 of 503 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 255 |
| Repositories with build-time execution (`EXEC`) | 324 |
