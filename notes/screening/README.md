...
**Progress: 303 of 420 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 146 |
| Repositories with build-time execution (`EXEC`) | 225 |
