...
**Progress: 459 of 520 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 272 |
| Repositories with build-time execution (`EXEC`) | 338 |
