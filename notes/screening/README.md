...
**Progress: 454 of 515 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 267 |
| Repositories with build-time execution (`EXEC`) | 333 |
