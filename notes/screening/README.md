...
**Progress: 491 of 552 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 300 |
| Repositories with build-time execution (`EXEC`) | 359 |
