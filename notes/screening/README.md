...
**Progress: 299 of 416 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 142 |
| Repositories with build-time execution (`EXEC`) | 223 |
