...
**Progress: 298 of 415 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 141 |
| Repositories with build-time execution (`EXEC`) | 222 |
