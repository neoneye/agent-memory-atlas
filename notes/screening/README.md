...
**Progress: 65 of 147 screened.**

| Result | Count |
| --- | ---: |
| Repositories with an auto-run surface (`RUNS`) | 24 |
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 16 |
| Repositories with build-time execution (`EXEC`) | 46 |
