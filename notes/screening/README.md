...
**Progress: 414 of 475 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 228 |
| Repositories with build-time execution (`EXEC`) | 300 |
