...
**Progress: 321 of 438 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 159 |
| Repositories with build-time execution (`EXEC`) | 240 |
