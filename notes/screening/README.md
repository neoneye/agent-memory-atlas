...
**Progress: 399 of 460 screened at the report's current pin.**
...
| Result | Count |
| --- | ---: |
| Repositories with an auto-run surface (`RUNS`) | 162 |
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 217 |
| Repositories with build-time execution (`EXEC`) | 288 |
