...
**Progress: 203 of 351 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 76 |
| Repositories with build-time execution (`EXEC`) | 156 |
