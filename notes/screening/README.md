...
**Progress: 306 of 423 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 149 |
| Repositories with build-time execution (`EXEC`) | 227 |
