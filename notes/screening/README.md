...
**Progress: 181 of 329 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 60 |
| Repositories with build-time execution (`EXEC`) | 141 |
