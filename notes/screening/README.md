...
**Progress: 420 of 481 screened at the report's current pin.**
...
| Result | Count |
| --- | ---: |
| Repositories with an auto-run surface (`RUNS`) | 174 |
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 235 |
| Repositories with build-time execution (`EXEC`) | 306 |
