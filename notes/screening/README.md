...
**Progress: 318 of 435 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 157 |
| Repositories with build-time execution (`EXEC`) | 237 |
