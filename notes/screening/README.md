...
**Progress: 178 of 327 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 59 |
| Repositories with build-time execution (`EXEC`) | 139 |
