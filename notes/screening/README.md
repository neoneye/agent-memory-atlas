...
**Progress: 521 of 573 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 315 |
| Repositories with build-time execution (`EXEC`) | 383 |
