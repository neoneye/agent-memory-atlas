...
**Progress: 239 of 385 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 99 |
| Repositories with build-time execution (`EXEC`) | 178 |
