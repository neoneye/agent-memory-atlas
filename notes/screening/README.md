...
**Progress: 577 of 579 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 323 |
| Repositories with build-time execution (`EXEC`) | 419 |
