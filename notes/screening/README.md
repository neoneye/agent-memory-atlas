...
**Progress: 50 of 147 screened.**

| Result | Count |
| --- | ---: |
| Repositories with an auto-run surface (`RUNS`) | 19 |
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 14 |
| Repositories with build-time execution (`EXEC`) | 33 |
