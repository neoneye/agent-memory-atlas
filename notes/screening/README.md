...
**Progress: 400 of 461 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 218 |
| Repositories with build-time execution (`EXEC`) | 289 |
