...
**Progress: 434 of 495 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 249 |
| Repositories with build-time execution (`EXEC`) | 316 |
