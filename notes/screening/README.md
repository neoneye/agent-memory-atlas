...
**Progress: 339 of 454 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 173 |
| Repositories with build-time execution (`EXEC`) | 251 |
