...
**Progress: 304 of 421 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 147 |
| Repositories with build-time execution (`EXEC`) | 226 |
