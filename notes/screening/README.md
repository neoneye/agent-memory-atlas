...
**Progress: 440 of 501 screened at the report's current pin.**
...
| Repositories with a dependency surface inside the cooldown (`FRESH`) | 254 |
| Repositories with build-time execution (`EXEC`) | 322 |
